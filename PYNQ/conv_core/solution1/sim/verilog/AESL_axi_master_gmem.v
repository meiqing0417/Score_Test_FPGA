...
module AESL_axi_master_gmem (
    ...
    TRAN_gmem_BID,
    TRAN_gmem_BUSER,
    TRAN_gmem_feature_in_V,
    TRAN_gmem_W_V,
    TRAN_gmem_feature_out_V,
    ready,
    done
    );
...
output [32 - 1 : 0] TRAN_gmem_feature_in_V;
output [32 - 1 : 0] TRAN_gmem_W_V;
output [32 - 1 : 0] TRAN_gmem_feature_out_V;
input ready;
input done;
...
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [32 - 1 : 0] feature_in_V = 0;
reg [32 - 1 : 0] W_V = 0;
reg [32 - 1 : 0] feature_out_V = 0;
...
assign    TRAN_gmem_feature_in_V = feature_in_V;
assign    TRAN_gmem_W_V = W_V;
assign    TRAN_gmem_feature_out_V = feature_out_V;
...
initial begin : initialize_offset
  ...
  feature_in_V <= 0 * DATA_byte_num;
  W_V <= 1 * DATA_byte_num;
  feature_out_V <= 2 * DATA_byte_num;
end
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("C:/Users/Caiyujie/Desktop/gongkaike_hls/code/day6/conv_core/solution1/sim/verilog/AESL_axi_master_gmem.v: Write request address %d exceed AXI master gmem array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("C:/Users/Caiyujie/Desktop/gongkaike_hls/code/day6/conv_core/solution1/sim/verilog/AESL_axi_master_gmem.v: Read request address %d exceed AXI master gmem array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
