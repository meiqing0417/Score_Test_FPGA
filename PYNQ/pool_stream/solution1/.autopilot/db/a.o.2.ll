...
.preheader:                                       ; preds = %8, %.preheader.preheader
  %. = phi i128 [ %.0219.1.lcssa, %8 ], [ undef, %.preheader.preheader ] ; [#uses=1 type=i128]
  %ptr = phi i32 [ %ptr.1.lcssa, %8 ], [ 0, %.preheader.preheader ] ; [#uses=1 type=i32]
  %c = phi i31 [ %c.1, %8 ], [ 0, %.preheader.preheader ] ; [#uses=2 type=i31]
  ...
  br i1 %tmp.1, label %0, label %10, !dbg !4207   ; [debug line = 117:13]
...
; <label>:1                                       ; preds = %6, %0
  %.0219.1 = phi i128 [ %., %0 ], [ %.0219.2.lcssa, %6 ] ; [#uses=2 type=i128]
  %ptr.1 = phi i32 [ %ptr, %0 ], [ %ptr_tp.lcssa, %6 ] ; [#uses=2 type=i32]
  %i = phi i31 [ 0, %0 ], [ %i.1, %6 ]            ; [#uses=2 type=i31]
  ...
  br i1 %tmp.2, label %2, label %8, !dbg !4210    ; [debug line = 120:13]
...
; <label>:3                                       ; preds = %._crit_edge, %2
  ...
  br i1 %tmp.5, label %4, label %6, !dbg !4214    ; [debug line = 123:13]
...
; <label>:4                                       ; preds = %3
  ...
  br i1 %tmp.9, label %_ifconv, label %._crit_edge, !dbg !4213 ; [debug line = 130:5]
...
_ifconv:                                          ; preds = %4
  ...
  %__Result__.4 = call i128 @llvm.part.set.i128.i16(i128 %.0219.2, i16 %__Result__, i32 0, i32 15), !dbg !4292 ; [#uses=1 type=i128] [debug line = 958:115@165:16]
  %tmp.22 = icmp sgt i16 %__Result__, %__Result__.1, !dbg !4298 ; [#uses=1 type=i1] [debug line = 2050:5@166:45]
  %tmp.23 = select i1 %tmp.22, i16 %__Result__, i16 %__Result__.1, !dbg !4302 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@166:45]
  %__Result__.5 = call i128 @llvm.part.set.i128.i16(i128 %.0219.2, i16 %tmp.23, i32 0, i32 15), !dbg !4306 ; [#uses=1 type=i128] [debug line = 958:115@166:45]
  %tmp.24 = icmp sgt i16 %__Result__.1, %__Result__.2, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tmp.16 = select i1 %tmp.24, i16 %__Result__.1, i16 %__Result__.2, !dbg !4307 ; [#uses=2 type=i16] [debug line = 2050:5@167:53]
  %tmp.17 = icmp sgt i16 %__Result__, %tmp.16, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tp_d0.V.1 = select i1 %tmp.17, i16 %__Result__, i16 %tmp.16, !dbg !4308 ; [#uses=1 type=i16] [debug line = 167:53]
  %__Result__.6 = call i128 @llvm.part.set.i128.i16(i128 %.0219.2, i16 %tp_d0.V.1, i32 0, i32 15), !dbg !4310 ; [#uses=1 type=i128] [debug line = 958:115@167:88]
  %tmp.18 = icmp sgt i16 %__Result__.2, %__Result__.3, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tmp.19 = select i1 %tmp.18, i16 %__Result__.2, i16 %__Result__.3, !dbg !4312 ; [#uses=2 type=i16] [debug line = 2050:5@168:61]
  %tmp.20 = icmp sgt i16 %__Result__.1, %tmp.19, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tp_d1.V.1 = select i1 %tmp.20, i16 %__Result__.1, i16 %tmp.19, !dbg !4313 ; [#uses=2 type=i16] [debug line = 168:61]
  %tmp.21 = icmp sgt i16 %__Result__, %tp_d1.V.1, !dbg !4315 ; [#uses=1 type=i1] [debug line = 2050:5@168:96]
  %.in347.ld = select i1 %tmp.21, i16 %__Result__, i16 %tp_d1.V.1, !dbg !4316 ; [#uses=1 type=i16] [debug line = 168:96]
  %__Result__.7 = call i128 @llvm.part.set.i128.i16(i128 %.0219.2, i16 %.in347.ld, i32 0, i32 15), !dbg !4317 ; [#uses=1 type=i128] [debug line = 958:115@168:175]
  %sel_tmp = icmp eq i32 %Ky, 4                   ; [#uses=8 type=i1]
  %sel_tmp1 = select i1 %sel_tmp, i128 %__Result__.7, i128 %.0219.2 ; [#uses=1 type=i128]
  %sel_tmp2 = icmp eq i32 %Ky, 3                  ; [#uses=8 type=i1]
  %sel_tmp3 = select i1 %sel_tmp2, i128 %__Result__.6, i128 %sel_tmp1 ; [#uses=1 type=i128]
  %sel_tmp4 = icmp eq i32 %Ky, 2                  ; [#uses=8 type=i1]
  %sel_tmp5 = select i1 %sel_tmp4, i128 %__Result__.5, i128 %sel_tmp3 ; [#uses=1 type=i128]
  %sel_tmp6 = icmp eq i32 %Ky, 1                  ; [#uses=8 type=i1]
  %.0219.4 = select i1 %sel_tmp6, i128 %__Result__.4, i128 %sel_tmp5 ; [#uses=5 type=i128]
  ...
  %__Result__.4.1 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4, i16 %__Result__., i32 16, i32 31), !dbg !4292 ; [#uses=1 type=i128] [debug line = 958:115@165:16]
  %tmp.13.1 = icmp sgt i16 %__Result__., %__Result__.1.1, !dbg !4298 ; [#uses=1 type=i1] [debug line = 2050:5@166:45]
  %tmp.14.1 = select i1 %tmp.13.1, i16 %__Result__., i16 %__Result__.1.1, !dbg !4302 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@166:45]
  %__Result__.5.1 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4, i16 %tmp.14.1, i32 16, i32 31), !dbg !4306 ; [#uses=1 type=i128] [debug line = 958:115@166:45]
  %tmp.15.1 = icmp sgt i16 %__Result__.1.1, %__Result__.2.1, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tmp.16.1 = select i1 %tmp.15.1, i16 %__Result__.1.1, i16 %__Result__.2.1, !dbg !4307 ; [#uses=2 type=i16] [debug line = 2050:5@167:53]
  %tmp.17.1 = icmp sgt i16 %__Result__., %tmp.16.1, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tp_d0.V.1.1 = select i1 %tmp.17.1, i16 %__Result__., i16 %tmp.16.1, !dbg !4308 ; [#uses=1 type=i16] [debug line = 167:53]
  %__Result__.6.1 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4, i16 %tp_d0.V.1.1, i32 16, i32 31), !dbg !4310 ; [#uses=1 type=i128] [debug line = 958:115@167:88]
  %tmp.18.1 = icmp sgt i16 %__Result__.2.1, %__Result__.3.1, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tmp.19.1 = select i1 %tmp.18.1, i16 %__Result__.2.1, i16 %__Result__.3.1, !dbg !4312 ; [#uses=2 type=i16] [debug line = 2050:5@168:61]
  %tmp.20.1 = icmp sgt i16 %__Result__.1.1, %tmp.19.1, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tp_d1.V.1.1 = select i1 %tmp.20.1, i16 %__Result__.1.1, i16 %tmp.19.1, !dbg !4313 ; [#uses=2 type=i16] [debug line = 168:61]
  %tmp.21.1 = icmp sgt i16 %__Result__., %tp_d1.V.1.1, !dbg !4315 ; [#uses=1 type=i1] [debug line = 2050:5@168:96]
  %.in347.ld.1 = select i1 %tmp.21.1, i16 %__Result__., i16 %tp_d1.V.1.1, !dbg !4316 ; [#uses=1 type=i16] [debug line = 168:96]
  %__Result__.7.1 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4, i16 %.in347.ld.1, i32 16, i32 31), !dbg !4317 ; [#uses=1 type=i128] [debug line = 958:115@168:175]
  %sel_tmp9 = select i1 %sel_tmp, i128 %__Result__.7.1, i128 %.0219.4 ; [#uses=1 type=i128]
  %sel_tmp7 = select i1 %sel_tmp2, i128 %__Result__.6.1, i128 %sel_tmp9 ; [#uses=1 type=i128]
  %sel_tmp8 = select i1 %sel_tmp4, i128 %__Result__.5.1, i128 %sel_tmp7 ; [#uses=1 type=i128]
  %.0219.4.1 = select i1 %sel_tmp6, i128 %__Result__.4.1, i128 %sel_tmp8 ; [#uses=5 type=i128]
  ...
  %__Result__.4.2 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.1, i16 %__Result__.8, i32 32, i32 47), !dbg !4292 ; [#uses=1 type=i128] [debug line = 958:115@165:16]
  %tmp.13.2 = icmp sgt i16 %__Result__.8, %__Result__.1.2, !dbg !4298 ; [#uses=1 type=i1] [debug line = 2050:5@166:45]
  %tmp.14.2 = select i1 %tmp.13.2, i16 %__Result__.8, i16 %__Result__.1.2, !dbg !4302 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@166:45]
  %__Result__.5.2 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.1, i16 %tmp.14.2, i32 32, i32 47), !dbg !4306 ; [#uses=1 type=i128] [debug line = 958:115@166:45]
  %tmp.15.2 = icmp sgt i16 %__Result__.1.2, %__Result__.2.2, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tmp.16.2 = select i1 %tmp.15.2, i16 %__Result__.1.2, i16 %__Result__.2.2, !dbg !4307 ; [#uses=2 type=i16] [debug line = 2050:5@167:53]
  %tmp.17.2 = icmp sgt i16 %__Result__.8, %tmp.16.2, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tp_d0.V.1.2 = select i1 %tmp.17.2, i16 %__Result__.8, i16 %tmp.16.2, !dbg !4308 ; [#uses=1 type=i16] [debug line = 167:53]
  %__Result__.6.2 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.1, i16 %tp_d0.V.1.2, i32 32, i32 47), !dbg !4310 ; [#uses=1 type=i128] [debug line = 958:115@167:88]
  %tmp.18.2 = icmp sgt i16 %__Result__.2.2, %__Result__.3.2, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tmp.19.2 = select i1 %tmp.18.2, i16 %__Result__.2.2, i16 %__Result__.3.2, !dbg !4312 ; [#uses=2 type=i16] [debug line = 2050:5@168:61]
  %tmp.20.2 = icmp sgt i16 %__Result__.1.2, %tmp.19.2, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tp_d1.V.1.2 = select i1 %tmp.20.2, i16 %__Result__.1.2, i16 %tmp.19.2, !dbg !4313 ; [#uses=2 type=i16] [debug line = 168:61]
  %tmp.21.2 = icmp sgt i16 %__Result__.8, %tp_d1.V.1.2, !dbg !4315 ; [#uses=1 type=i1] [debug line = 2050:5@168:96]
  %.in347.ld.2 = select i1 %tmp.21.2, i16 %__Result__.8, i16 %tp_d1.V.1.2, !dbg !4316 ; [#uses=1 type=i16] [debug line = 168:96]
  %__Result__.7.2 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.1, i16 %.in347.ld.2, i32 32, i32 47), !dbg !4317 ; [#uses=1 type=i128] [debug line = 958:115@168:175]
  %sel_tmp10 = select i1 %sel_tmp, i128 %__Result__.7.2, i128 %.0219.4.1 ; [#uses=1 type=i128]
  %sel_tmp11 = select i1 %sel_tmp2, i128 %__Result__.6.2, i128 %sel_tmp10 ; [#uses=1 type=i128]
  %sel_tmp12 = select i1 %sel_tmp4, i128 %__Result__.5.2, i128 %sel_tmp11 ; [#uses=1 type=i128]
  %.0219.4.2 = select i1 %sel_tmp6, i128 %__Result__.4.2, i128 %sel_tmp12 ; [#uses=5 type=i128]
  ...
  %__Result__.4.3 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.2, i16 %__Result__.9, i32 48, i32 63), !dbg !4292 ; [#uses=1 type=i128] [debug line = 958:115@165:16]
  %tmp.13.3 = icmp sgt i16 %__Result__.9, %__Result__.1.3, !dbg !4298 ; [#uses=1 type=i1] [debug line = 2050:5@166:45]
  %tmp.14.3 = select i1 %tmp.13.3, i16 %__Result__.9, i16 %__Result__.1.3, !dbg !4302 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@166:45]
  %__Result__.5.3 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.2, i16 %tmp.14.3, i32 48, i32 63), !dbg !4306 ; [#uses=1 type=i128] [debug line = 958:115@166:45]
  %tmp.15.3 = icmp sgt i16 %__Result__.1.3, %__Result__.2.3, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tmp.16.3 = select i1 %tmp.15.3, i16 %__Result__.1.3, i16 %__Result__.2.3, !dbg !4307 ; [#uses=2 type=i16] [debug line = 2050:5@167:53]
  %tmp.17.3 = icmp sgt i16 %__Result__.9, %tmp.16.3, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tp_d0.V.1.3 = select i1 %tmp.17.3, i16 %__Result__.9, i16 %tmp.16.3, !dbg !4308 ; [#uses=1 type=i16] [debug line = 167:53]
  %__Result__.6.3 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.2, i16 %tp_d0.V.1.3, i32 48, i32 63), !dbg !4310 ; [#uses=1 type=i128] [debug line = 958:115@167:88]
  %tmp.18.3 = icmp sgt i16 %__Result__.2.3, %__Result__.3.3, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tmp.19.3 = select i1 %tmp.18.3, i16 %__Result__.2.3, i16 %__Result__.3.3, !dbg !4312 ; [#uses=2 type=i16] [debug line = 2050:5@168:61]
  %tmp.20.3 = icmp sgt i16 %__Result__.1.3, %tmp.19.3, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tp_d1.V.1.3 = select i1 %tmp.20.3, i16 %__Result__.1.3, i16 %tmp.19.3, !dbg !4313 ; [#uses=2 type=i16] [debug line = 168:61]
  %tmp.21.3 = icmp sgt i16 %__Result__.9, %tp_d1.V.1.3, !dbg !4315 ; [#uses=1 type=i1] [debug line = 2050:5@168:96]
  %.in347.ld.3 = select i1 %tmp.21.3, i16 %__Result__.9, i16 %tp_d1.V.1.3, !dbg !4316 ; [#uses=1 type=i16] [debug line = 168:96]
  %__Result__.7.3 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.2, i16 %.in347.ld.3, i32 48, i32 63), !dbg !4317 ; [#uses=1 type=i128] [debug line = 958:115@168:175]
  %sel_tmp13 = select i1 %sel_tmp, i128 %__Result__.7.3, i128 %.0219.4.2 ; [#uses=1 type=i128]
  %sel_tmp14 = select i1 %sel_tmp2, i128 %__Result__.6.3, i128 %sel_tmp13 ; [#uses=1 type=i128]
  %sel_tmp15 = select i1 %sel_tmp4, i128 %__Result__.5.3, i128 %sel_tmp14 ; [#uses=1 type=i128]
  %.0219.4.3 = select i1 %sel_tmp6, i128 %__Result__.4.3, i128 %sel_tmp15 ; [#uses=5 type=i128]
  ...
  %__Result__.4.4 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.3, i16 %__Result__.10, i32 64, i32 79), !dbg !4292 ; [#uses=1 type=i128] [debug line = 958:115@165:16]
  %tmp.13.4 = icmp sgt i16 %__Result__.10, %__Result__.1.4, !dbg !4298 ; [#uses=1 type=i1] [debug line = 2050:5@166:45]
  %tmp.14.4 = select i1 %tmp.13.4, i16 %__Result__.10, i16 %__Result__.1.4, !dbg !4302 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@166:45]
  %__Result__.5.4 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.3, i16 %tmp.14.4, i32 64, i32 79), !dbg !4306 ; [#uses=1 type=i128] [debug line = 958:115@166:45]
  %tmp.15.4 = icmp sgt i16 %__Result__.1.4, %__Result__.2.4, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tmp.16.4 = select i1 %tmp.15.4, i16 %__Result__.1.4, i16 %__Result__.2.4, !dbg !4307 ; [#uses=2 type=i16] [debug line = 2050:5@167:53]
  %tmp.17.4 = icmp sgt i16 %__Result__.10, %tmp.16.4, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tp_d0.V.1.4 = select i1 %tmp.17.4, i16 %__Result__.10, i16 %tmp.16.4, !dbg !4308 ; [#uses=1 type=i16] [debug line = 167:53]
  %__Result__.6.4 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.3, i16 %tp_d0.V.1.4, i32 64, i32 79), !dbg !4310 ; [#uses=1 type=i128] [debug line = 958:115@167:88]
  %tmp.18.4 = icmp sgt i16 %__Result__.2.4, %__Result__.3.4, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tmp.19.4 = select i1 %tmp.18.4, i16 %__Result__.2.4, i16 %__Result__.3.4, !dbg !4312 ; [#uses=2 type=i16] [debug line = 2050:5@168:61]
  %tmp.20.4 = icmp sgt i16 %__Result__.1.4, %tmp.19.4, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tp_d1.V.1.4 = select i1 %tmp.20.4, i16 %__Result__.1.4, i16 %tmp.19.4, !dbg !4313 ; [#uses=2 type=i16] [debug line = 168:61]
  %tmp.21.4 = icmp sgt i16 %__Result__.10, %tp_d1.V.1.4, !dbg !4315 ; [#uses=1 type=i1] [debug line = 2050:5@168:96]
  %.in347.ld.4 = select i1 %tmp.21.4, i16 %__Result__.10, i16 %tp_d1.V.1.4, !dbg !4316 ; [#uses=1 type=i16] [debug line = 168:96]
  %__Result__.7.4 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.3, i16 %.in347.ld.4, i32 64, i32 79), !dbg !4317 ; [#uses=1 type=i128] [debug line = 958:115@168:175]
  %sel_tmp16 = select i1 %sel_tmp, i128 %__Result__.7.4, i128 %.0219.4.3 ; [#uses=1 type=i128]
  %sel_tmp17 = select i1 %sel_tmp2, i128 %__Result__.6.4, i128 %sel_tmp16 ; [#uses=1 type=i128]
  %sel_tmp18 = select i1 %sel_tmp4, i128 %__Result__.5.4, i128 %sel_tmp17 ; [#uses=1 type=i128]
  %.0219.4.4 = select i1 %sel_tmp6, i128 %__Result__.4.4, i128 %sel_tmp18 ; [#uses=5 type=i128]
  ...
  %__Result__.4.5 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.4, i16 %__Result__.11, i32 80, i32 95), !dbg !4292 ; [#uses=1 type=i128] [debug line = 958:115@165:16]
  %tmp.13.5 = icmp sgt i16 %__Result__.11, %__Result__.1.5, !dbg !4298 ; [#uses=1 type=i1] [debug line = 2050:5@166:45]
  %tmp.14.5 = select i1 %tmp.13.5, i16 %__Result__.11, i16 %__Result__.1.5, !dbg !4302 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@166:45]
  %__Result__.5.5 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.4, i16 %tmp.14.5, i32 80, i32 95), !dbg !4306 ; [#uses=1 type=i128] [debug line = 958:115@166:45]
  %tmp.15.5 = icmp sgt i16 %__Result__.1.5, %__Result__.2.5, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tmp.16.5 = select i1 %tmp.15.5, i16 %__Result__.1.5, i16 %__Result__.2.5, !dbg !4307 ; [#uses=2 type=i16] [debug line = 2050:5@167:53]
  %tmp.17.5 = icmp sgt i16 %__Result__.11, %tmp.16.5, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tp_d0.V.1.5 = select i1 %tmp.17.5, i16 %__Result__.11, i16 %tmp.16.5, !dbg !4308 ; [#uses=1 type=i16] [debug line = 167:53]
  %__Result__.6.5 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.4, i16 %tp_d0.V.1.5, i32 80, i32 95), !dbg !4310 ; [#uses=1 type=i128] [debug line = 958:115@167:88]
  %tmp.18.5 = icmp sgt i16 %__Result__.2.5, %__Result__.3.5, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tmp.19.5 = select i1 %tmp.18.5, i16 %__Result__.2.5, i16 %__Result__.3.5, !dbg !4312 ; [#uses=2 type=i16] [debug line = 2050:5@168:61]
  %tmp.20.5 = icmp sgt i16 %__Result__.1.5, %tmp.19.5, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tp_d1.V.1.5 = select i1 %tmp.20.5, i16 %__Result__.1.5, i16 %tmp.19.5, !dbg !4313 ; [#uses=2 type=i16] [debug line = 168:61]
  %tmp.21.5 = icmp sgt i16 %__Result__.11, %tp_d1.V.1.5, !dbg !4315 ; [#uses=1 type=i1] [debug line = 2050:5@168:96]
  %.in347.ld.5 = select i1 %tmp.21.5, i16 %__Result__.11, i16 %tp_d1.V.1.5, !dbg !4316 ; [#uses=1 type=i16] [debug line = 168:96]
  %__Result__.7.5 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.4, i16 %.in347.ld.5, i32 80, i32 95), !dbg !4317 ; [#uses=1 type=i128] [debug line = 958:115@168:175]
  %sel_tmp19 = select i1 %sel_tmp, i128 %__Result__.7.5, i128 %.0219.4.4 ; [#uses=1 type=i128]
  %sel_tmp20 = select i1 %sel_tmp2, i128 %__Result__.6.5, i128 %sel_tmp19 ; [#uses=1 type=i128]
  %sel_tmp21 = select i1 %sel_tmp4, i128 %__Result__.5.5, i128 %sel_tmp20 ; [#uses=1 type=i128]
  %.0219.4.5 = select i1 %sel_tmp6, i128 %__Result__.4.5, i128 %sel_tmp21 ; [#uses=5 type=i128]
  ...
  %__Result__.4.6 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.5, i16 %__Result__.12, i32 96, i32 111), !dbg !4292 ; [#uses=1 type=i128] [debug line = 958:115@165:16]
  %tmp.13.6 = icmp sgt i16 %__Result__.12, %__Result__.1.6, !dbg !4298 ; [#uses=1 type=i1] [debug line = 2050:5@166:45]
  %tmp.14.6 = select i1 %tmp.13.6, i16 %__Result__.12, i16 %__Result__.1.6, !dbg !4302 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@166:45]
  %__Result__.5.6 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.5, i16 %tmp.14.6, i32 96, i32 111), !dbg !4306 ; [#uses=1 type=i128] [debug line = 958:115@166:45]
  %tmp.15.6 = icmp sgt i16 %__Result__.1.6, %__Result__.2.6, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tmp.16.6 = select i1 %tmp.15.6, i16 %__Result__.1.6, i16 %__Result__.2.6, !dbg !4307 ; [#uses=2 type=i16] [debug line = 2050:5@167:53]
  %tmp.17.6 = icmp sgt i16 %__Result__.12, %tmp.16.6, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tp_d0.V.1.6 = select i1 %tmp.17.6, i16 %__Result__.12, i16 %tmp.16.6, !dbg !4308 ; [#uses=1 type=i16] [debug line = 167:53]
  %__Result__.6.6 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.5, i16 %tp_d0.V.1.6, i32 96, i32 111), !dbg !4310 ; [#uses=1 type=i128] [debug line = 958:115@167:88]
  %tmp.18.6 = icmp sgt i16 %__Result__.2.6, %__Result__.3.6, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tmp.19.6 = select i1 %tmp.18.6, i16 %__Result__.2.6, i16 %__Result__.3.6, !dbg !4312 ; [#uses=2 type=i16] [debug line = 2050:5@168:61]
  %tmp.20.6 = icmp sgt i16 %__Result__.1.6, %tmp.19.6, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tp_d1.V.1.6 = select i1 %tmp.20.6, i16 %__Result__.1.6, i16 %tmp.19.6, !dbg !4313 ; [#uses=2 type=i16] [debug line = 168:61]
  %tmp.21.6 = icmp sgt i16 %__Result__.12, %tp_d1.V.1.6, !dbg !4315 ; [#uses=1 type=i1] [debug line = 2050:5@168:96]
  %.in347.ld.6 = select i1 %tmp.21.6, i16 %__Result__.12, i16 %tp_d1.V.1.6, !dbg !4316 ; [#uses=1 type=i16] [debug line = 168:96]
  %__Result__.7.6 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.5, i16 %.in347.ld.6, i32 96, i32 111), !dbg !4317 ; [#uses=1 type=i128] [debug line = 958:115@168:175]
  %sel_tmp22 = select i1 %sel_tmp, i128 %__Result__.7.6, i128 %.0219.4.5 ; [#uses=1 type=i128]
  %sel_tmp23 = select i1 %sel_tmp2, i128 %__Result__.6.6, i128 %sel_tmp22 ; [#uses=1 type=i128]
  %sel_tmp24 = select i1 %sel_tmp4, i128 %__Result__.5.6, i128 %sel_tmp23 ; [#uses=1 type=i128]
  %.0219.4.6 = select i1 %sel_tmp6, i128 %__Result__.4.6, i128 %sel_tmp24 ; [#uses=5 type=i128]
  ...
  %__Result__.4.7 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.6, i16 %__Result__.13, i32 112, i32 127), !dbg !4292 ; [#uses=1 type=i128] [debug line = 958:115@165:16]
  %tmp.13.7 = icmp sgt i16 %__Result__.13, %__Result__.1.7, !dbg !4298 ; [#uses=1 type=i1] [debug line = 2050:5@166:45]
  %tmp.14.7 = select i1 %tmp.13.7, i16 %__Result__.13, i16 %__Result__.1.7, !dbg !4302 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@166:45]
  %__Result__.5.7 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.6, i16 %tmp.14.7, i32 112, i32 127), !dbg !4306 ; [#uses=1 type=i128] [debug line = 958:115@166:45]
  %tmp.15.7 = icmp sgt i16 %__Result__.1.7, %__Result__.2.7, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tmp.16.7 = select i1 %tmp.15.7, i16 %__Result__.1.7, i16 %__Result__.2.7, !dbg !4307 ; [#uses=2 type=i16] [debug line = 2050:5@167:53]
  %tmp.17.7 = icmp sgt i16 %__Result__.13, %tmp.16.7, !dbg !4307 ; [#uses=1 type=i1] [debug line = 2050:5@167:53]
  %tp_d0.V.1.7 = select i1 %tmp.17.7, i16 %__Result__.13, i16 %tmp.16.7, !dbg !4308 ; [#uses=1 type=i16] [debug line = 167:53]
  %__Result__.6.7 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.6, i16 %tp_d0.V.1.7, i32 112, i32 127), !dbg !4310 ; [#uses=1 type=i128] [debug line = 958:115@167:88]
  %tmp.18.7 = icmp sgt i16 %__Result__.2.7, %__Result__.3.7, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tmp.19.7 = select i1 %tmp.18.7, i16 %__Result__.2.7, i16 %__Result__.3.7, !dbg !4312 ; [#uses=2 type=i16] [debug line = 2050:5@168:61]
  %tmp.20.7 = icmp sgt i16 %__Result__.1.7, %tmp.19.7, !dbg !4312 ; [#uses=1 type=i1] [debug line = 2050:5@168:61]
  %tp_d1.V.1.7 = select i1 %tmp.20.7, i16 %__Result__.1.7, i16 %tmp.19.7, !dbg !4313 ; [#uses=2 type=i16] [debug line = 168:61]
  %tmp.21.7 = icmp sgt i16 %__Result__.13, %tp_d1.V.1.7, !dbg !4315 ; [#uses=1 type=i1] [debug line = 2050:5@168:96]
  %.in347.ld.7 = select i1 %tmp.21.7, i16 %__Result__.13, i16 %tp_d1.V.1.7, !dbg !4316 ; [#uses=1 type=i16] [debug line = 168:96]
  %__Result__.7.7 = call i128 @llvm.part.set.i128.i16(i128 %.0219.4.6, i16 %.in347.ld.7, i32 112, i32 127), !dbg !4317 ; [#uses=1 type=i128] [debug line = 958:115@168:175]
  %sel_tmp25 = select i1 %sel_tmp, i128 %__Result__.7.7, i128 %.0219.4.6, !dbg !4319 ; [#uses=1 type=i128] [debug line = 145:31@171:6]
  %sel_tmp26 = select i1 %sel_tmp2, i128 %__Result__.6.7, i128 %sel_tmp25, !dbg !4319 ; [#uses=1 type=i128] [debug line = 145:31@171:6]
  %sel_tmp27 = select i1 %sel_tmp4, i128 %__Result__.5.7, i128 %sel_tmp26, !dbg !4319 ; [#uses=1 type=i128] [debug line = 145:31@171:6]
  %tmp.V.3 = select i1 %sel_tmp6, i128 %__Result__.4.7, i128 %sel_tmp27, !dbg !4319 ; [#uses=2 type=i128] [debug line = 145:31@171:6]
  call void @llvm.dbg.value(metadata !{i128* %out.V.V}, i64 0, metadata !4322), !dbg !4324 ; [debug line = 144:48@171:6] [debug variable = stream<ap_int<128> >.V.V]
  call void @llvm.dbg.declare(metadata !{i128* %tmp.V}, metadata !4325), !dbg !4327 ; [debug line = 145:22@171:6] [debug variable = tmp.V]
  call void @llvm.dbg.value(metadata !{i128 %tmp.V.3}, i64 0, metadata !4325), !dbg !4319 ; [debug line = 145:31@171:6] [debug variable = tmp.V]
  call void @llvm.dbg.value(metadata !{i128 %tmp.V.3}, i64 0, metadata !4325), !dbg !4319 ; [debug line = 145:31@171:6] [debug variable = tmp.V]
  store i128 %tmp.V.3, i128* %tmp.V, align 16, !dbg !4319 ; [debug line = 145:31@171:6]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_int.2 = type { %struct.ap_int_base.1 }P.%struct.ap_int.2 = type { %struct.ap_int_base.1 }P"(i128* %out.V.V, i128* %tmp.V), !dbg !4328 ; [debug line = 146:9@171:6]
  br label %._crit_edge, !dbg !4329               ; [debug line = 172:5]

._crit_edge:                                      ; preds = %_ifconv, %4
  %.0219.5 = phi i128 [ %tmp.V.3, %_ifconv ], [ %.0219.2, %4 ] ; [#uses=1 type=i128]
  %tmp.12 = icmp eq i32 %ptr_tp, 127, !dbg !4330  ; [#uses=1 type=i1] [debug line = 174:5]
  %ptr.2 = add nsw i32 %ptr_tp, 1, !dbg !4331     ; [#uses=1 type=i32] [debug line = 177:6]
  call void @llvm.dbg.value(metadata !{i32 %ptr.2}, i64 0, metadata !4332), !dbg !4331 ; [debug line = 177:6] [debug variable = ptr]
  %ptr.3 = select i1 %tmp.12, i32 0, i32 %ptr.2, !dbg !4330 ; [#uses=1 type=i32] [debug line = 174:5]
  call void @llvm.dbg.value(metadata !{i32 %ptr.3}, i64 0, metadata !4332), !dbg !4330 ; [debug line = 174:5] [debug variable = ptr]
  %5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str11, i32 %tmp.15), !dbg !4333 ; [#uses=0 type=i32] [debug line = 178:4]
  %j.1 = add i31 %j, 1, !dbg !4334                ; [#uses=1 type=i31] [debug line = 123:26]
  call void @llvm.dbg.value(metadata !{i31 %j.1}, i64 0, metadata !4335), !dbg !4334 ; [debug line = 123:26] [debug variable = j]
  br label %3, !dbg !4334                         ; [debug line = 123:26]

; <label>:6                                       ; preds = %3
  %ptr_tp.lcssa = phi i32 [ %ptr_tp, %3 ]         ; [#uses=1 type=i32]
  %.0219.2.lcssa = phi i128 [ %.0219.2, %3 ]      ; [#uses=1 type=i128]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.14), !dbg !4336 ; [#uses=0 type=i32] [debug line = 179:3]
  call void @llvm.dbg.value(metadata !{i31 %i.1}, i64 0, metadata !4337), !dbg !4338 ; [debug line = 120:26] [debug variable = i]
  br label %1, !dbg !4338                         ; [debug line = 120:26]

; <label>:8                                       ; preds = %1
  %ptr.1.lcssa = phi i32 [ %ptr.1, %1 ]           ; [#uses=1 type=i32]
  %.0219.1.lcssa = phi i128 [ %.0219.1, %1 ]      ; [#uses=1 type=i128]
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str9, i32 %tmp.13), !dbg !4339 ; [#uses=0 type=i32] [debug line = 180:2]
  %c.1 = add i31 %c, 1, !dbg !4340                ; [#uses=1 type=i31] [debug line = 117:25]
  call void @llvm.dbg.value(metadata !{i31 %c.1}, i64 0, metadata !4341), !dbg !4340 ; [debug line = 117:25] [debug variable = c]
  br label %.preheader, !dbg !4340                ; [debug line = 117:25]

; <label>:10                                      ; preds = %.preheader
  ret void, !dbg !4342                            ; [debug line = 181:1]
}
...
define internal fastcc void @pool_1D(i128* %in.V.V, i128* %out.V.V, i32 %ch_div_K, i32 %height_in, i32 %width_in, i32 %Kx) {
  ...
  call void @llvm.dbg.value(metadata !{i128* %in.V.V}, i64 0, metadata !4343), !dbg !4345 ; [debug line = 51:38] [debug variable = in.V.V]
  call void @llvm.dbg.value(metadata !{i128* %out.V.V}, i64 0, metadata !4346), !dbg !4348 ; [debug line = 51:65] [debug variable = out.V.V]
  call void @llvm.dbg.value(metadata !{i32 %ch_div_K}, i64 0, metadata !4349), !dbg !4350 ; [debug line = 51:73] [debug variable = ch_div_K]
  call void @llvm.dbg.value(metadata !{i32 %height_in}, i64 0, metadata !4351), !dbg !4352 ; [debug line = 51:86] [debug variable = height_in]
  call void @llvm.dbg.value(metadata !{i32 %width_in}, i64 0, metadata !4353), !dbg !4354 ; [debug line = 51:100] [debug variable = width_in]
  call void @llvm.dbg.value(metadata !{i32 %Kx}, i64 0, metadata !4355), !dbg !4356 ; [debug line = 51:113] [debug variable = Kx]
  call void (...)* @_ssdm_op_SpecInterface(i32 %width_in, [10 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4357 ; [debug line = 56:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %Kx, [10 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4359 ; [debug line = 57:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %height_in, [10 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4360 ; [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %ch_div_K, [10 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4361 ; [debug line = 59:1]
  br label %1, !dbg !4362                         ; [debug line = 63:13]

; <label>:1                                       ; preds = %10, %0
  %. = phi i128 [ undef, %0 ], [ %.0215.1.lcssa, %10 ] ; [#uses=1 type=i128]
  %.0232. = phi i128 [ undef, %0 ], [ %.0232.1.lcssa, %10 ] ; [#uses=1 type=i128]
  %.0230. = phi i128 [ undef, %0 ], [ %.0230.1.lcssa, %10 ] ; [#uses=1 type=i128]
  %.0228. = phi i128 [ undef, %0 ], [ %.0228.1.lcssa, %10 ] ; [#uses=1 type=i128]
  %c = phi i31 [ 0, %0 ], [ %c.2, %10 ]           ; [#uses=2 type=i31]
  %c.cast = zext i31 %c to i32, !dbg !4362        ; [#uses=1 type=i32] [debug line = 63:13]
  %tmp = icmp slt i32 %c.cast, %ch_div_K, !dbg !4362 ; [#uses=1 type=i1] [debug line = 63:13]
  br i1 %tmp, label %2, label %12, !dbg !4362     ; [debug line = 63:13]

; <label>:2                                       ; preds = %1
  %tmp.16 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str6), !dbg !4364 ; [#uses=1 type=i32] [debug line = 64:3]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 1, i32 1, i32 1, [1 x i8]* @.str1) nounwind, !dbg !4366 ; [debug line = 65:1]
  br label %3, !dbg !4367                         ; [debug line = 66:13]

; <label>:3                                       ; preds = %8, %2
  %.0215.1 = phi i128 [ %., %2 ], [ %.0215.2.lcssa, %8 ] ; [#uses=2 type=i128]
  %.0232.1 = phi i128 [ %.0232., %2 ], [ %in_d3.V.lcssa, %8 ] ; [#uses=2 type=i128]
  %.0230.1 = phi i128 [ %.0230., %2 ], [ %in_d2.V.lcssa, %8 ] ; [#uses=2 type=i128]
  %.0228.1 = phi i128 [ %.0228., %2 ], [ %in_d1.V.lcssa, %8 ] ; [#uses=2 type=i128]
  %i = phi i31 [ 0, %2 ], [ %i.2, %8 ]            ; [#uses=2 type=i31]
  %i.cast = zext i31 %i to i32, !dbg !4367        ; [#uses=1 type=i32] [debug line = 66:13]
  %tmp. = icmp slt i32 %i.cast, %height_in, !dbg !4367 ; [#uses=1 type=i1] [debug line = 66:13]
  br i1 %tmp., label %4, label %10, !dbg !4367    ; [debug line = 66:13]

; <label>:4                                       ; preds = %3
  %tmp.17 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str7), !dbg !4369 ; [#uses=1 type=i32] [debug line = 67:4]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 20, i32 20, i32 20, [1 x i8]* @.str1) nounwind, !dbg !4371 ; [debug line = 68:1]
  br label %5, !dbg !4372                         ; [debug line = 69:13]
...
; <label>:5                                       ; preds = %._crit_edge, %4
  ...
  %j.cast = zext i31 %j to i32, !dbg !4372        ; [#uses=1 type=i32] [debug line = 69:13]
  %tmp.13 = icmp slt i32 %j.cast, %width_in, !dbg !4372 ; [#uses=1 type=i1] [debug line = 69:13]
  br i1 %tmp.13, label %6, label %8, !dbg !4372   ; [debug line = 69:13]

; <label>:6                                       ; preds = %5
  %tmp.18 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str8), !dbg !4374 ; [#uses=1 type=i32] [debug line = 70:5]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !4376 ; [debug line = 71:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 20, i32 20, i32 20, [1 x i8]* @.str1) nounwind, !dbg !4377 ; [debug line = 72:1]
  call void @llvm.dbg.value(metadata !{i128 %in_d3.V}, i64 0, metadata !4378), !dbg !4380 ; [debug line = 174:5@74:2] [debug variable = in_d3.V]
  call void @llvm.dbg.value(metadata !{i128 %in_d2.V}, i64 0, metadata !4382), !dbg !4384 ; [debug line = 174:5@74:14] [debug variable = in_d2.V]
  call void @llvm.dbg.value(metadata !{i128 %in_d1.V}, i64 0, metadata !4386), !dbg !4388 ; [debug line = 174:5@74:26] [debug variable = in_d1.V]
  call void @llvm.dbg.value(metadata !{i128* %in.V.V}, i64 0, metadata !4219), !dbg !4390 ; [debug line = 129:56@75:11] [debug variable = stream<ap_int<128> >.V.V]
  call void @llvm.dbg.declare(metadata !{i128* %tmp.V.6}, metadata !4225), !dbg !4392 ; [debug line = 130:22@75:11] [debug variable = tmp.V]
  call void @"_ssdm_op_IfRead.Stream.%struct.ap_int.2 = type { %struct.ap_int_base.1 }P.%struct.ap_int.2 = type { %struct.ap_int_base.1 }P"(i128* %in.V.V, i128* %tmp.V.6), !dbg !4393 ; [debug line = 131:9@75:11]
  call void @llvm.dbg.value(metadata !{i128* %tmp.V.6}, i64 0, metadata !4230), !dbg !4394 ; [debug line = 173:82@75:11] [debug variable = op2.V]
  call void @llvm.dbg.value(metadata !{i128* %tmp.V.6}, i64 0, metadata !4225), !dbg !4395 ; [debug line = 174:5@75:11] [debug variable = tmp.V]
  call void @llvm.dbg.value(metadata !{i128* %tmp.V.6}, i64 0, metadata !4225), !dbg !4395 ; [debug line = 174:5@75:11] [debug variable = tmp.V]
  %in_d0.V = load i128* %tmp.V.6, align 16, !dbg !4395 ; [#uses=9 type=i128] [debug line = 174:5@75:11]
  call void @llvm.dbg.value(metadata !{i128 %in_d0.V}, i64 0, metadata !4396), !dbg !4395 ; [debug line = 174:5@75:11] [debug variable = in_d0.V]
  %j.2 = add i31 %j, 1, !dbg !4398                ; [#uses=2 type=i31] [debug line = 78:5]
  %j.2.cast = zext i31 %j.2 to i32, !dbg !4398    ; [#uses=1 type=i32] [debug line = 78:5]
  %tmp.14 = srem i32 %j.2.cast, %Kx, !dbg !4398   ; [#uses=1 type=i32] [debug line = 78:5]
  %tmp.15 = icmp eq i32 %tmp.14, 0, !dbg !4398    ; [#uses=1 type=i1] [debug line = 78:5]
  br i1 %tmp.15, label %.preheader.0_ifconv, label %._crit_edge, !dbg !4398 ; [debug line = 78:5]

.preheader.0_ifconv:                              ; preds = %6
  call void @llvm.dbg.value(metadata !{i128 %in_d0.V}, i64 0, metadata !4262), !dbg !4399 ; [debug line = 941:79@1538:15@91:99@91:100@82:23] [debug variable = __Val2__]
  %__Result__ = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d0.V, i32 0, i32 15), !dbg !4407 ; [#uses=7 type=i16] [debug line = 941:81@1538:15@91:99@91:100@82:23]
  call void @llvm.dbg.value(metadata !{i128 %in_d1.V}, i64 0, metadata !4262), !dbg !4408 ; [debug line = 941:79@1538:15@91:99@91:100@83:23] [debug variable = __Val2__]
  %__Result__.8 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d1.V, i32 0, i32 15), !dbg !4413 ; [#uses=6 type=i16] [debug line = 941:81@1538:15@91:99@91:100@83:23]
  call void @llvm.dbg.value(metadata !{i128 %in_d2.V}, i64 0, metadata !4262), !dbg !4414 ; [debug line = 941:79@1538:15@91:99@91:100@84:23] [debug variable = __Val2__]
  %__Result__.9 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d2.V, i32 0, i32 15), !dbg !4419 ; [#uses=4 type=i16] [debug line = 941:81@1538:15@91:99@91:100@84:23]
  call void @llvm.dbg.value(metadata !{i128 %in_d3.V}, i64 0, metadata !4262), !dbg !4420 ; [debug line = 941:79@1538:15@91:99@91:100@85:23] [debug variable = __Val2__]
  %__Result__.10 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d3.V, i32 0, i32 15), !dbg !4425 ; [#uses=2 type=i16] [debug line = 941:81@1538:15@91:99@91:100@85:23]
  %__Result__.11 = call i128 @llvm.part.set.i128.i16(i128 %.0215.2, i16 %__Result__, i32 0, i32 15), !dbg !4426 ; [#uses=1 type=i128] [debug line = 958:115@89:16]
  %tmp.25 = icmp sgt i16 %__Result__, %__Result__.8, !dbg !4430 ; [#uses=1 type=i1] [debug line = 2050:5@90:45]
  %tmp.26 = select i1 %tmp.25, i16 %__Result__, i16 %__Result__.8, !dbg !4433 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@90:45]
  %__Result__.12 = call i128 @llvm.part.set.i128.i16(i128 %.0215.2, i16 %tmp.26, i32 0, i32 15), !dbg !4436 ; [#uses=1 type=i128] [debug line = 958:115@90:45]
  %tmp.27 = icmp sgt i16 %__Result__.8, %__Result__.9, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tmp.28 = select i1 %tmp.27, i16 %__Result__.8, i16 %__Result__.9, !dbg !4437 ; [#uses=2 type=i16] [debug line = 2050:5@91:53]
  %tmp.29 = icmp sgt i16 %__Result__, %tmp.28, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tp_d0.V.2 = select i1 %tmp.29, i16 %__Result__, i16 %tmp.28, !dbg !4438 ; [#uses=1 type=i16] [debug line = 91:53]
  %__Result__.13 = call i128 @llvm.part.set.i128.i16(i128 %.0215.2, i16 %tp_d0.V.2, i32 0, i32 15), !dbg !4440 ; [#uses=1 type=i128] [debug line = 958:115@91:88]
  %tmp.30 = icmp sgt i16 %__Result__.9, %__Result__.10, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tmp.31 = select i1 %tmp.30, i16 %__Result__.9, i16 %__Result__.10, !dbg !4442 ; [#uses=2 type=i16] [debug line = 2050:5@92:61]
  %tmp.32 = icmp sgt i16 %__Result__.8, %tmp.31, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tp_d1.V.2 = select i1 %tmp.32, i16 %__Result__.8, i16 %tmp.31, !dbg !4443 ; [#uses=2 type=i16] [debug line = 92:61]
  %tmp.33 = icmp sgt i16 %__Result__, %tp_d1.V.2, !dbg !4445 ; [#uses=1 type=i1] [debug line = 2050:5@92:96]
  %.in353.ld = select i1 %tmp.33, i16 %__Result__, i16 %tp_d1.V.2, !dbg !4446 ; [#uses=1 type=i16] [debug line = 92:96]
  %__Result__. = call i128 @llvm.part.set.i128.i16(i128 %.0215.2, i16 %.in353.ld, i32 0, i32 15), !dbg !4447 ; [#uses=1 type=i128] [debug line = 958:115@92:175]
  %sel_tmp = icmp eq i32 %Kx, 4                   ; [#uses=8 type=i1]
  %sel_tmp1 = select i1 %sel_tmp, i128 %__Result__., i128 %.0215.2 ; [#uses=1 type=i128]
  %sel_tmp2 = icmp eq i32 %Kx, 3                  ; [#uses=8 type=i1]
  %sel_tmp3 = select i1 %sel_tmp2, i128 %__Result__.13, i128 %sel_tmp1 ; [#uses=1 type=i128]
  %sel_tmp4 = icmp eq i32 %Kx, 2                  ; [#uses=8 type=i1]
  %sel_tmp5 = select i1 %sel_tmp4, i128 %__Result__.12, i128 %sel_tmp3 ; [#uses=1 type=i128]
  %sel_tmp6 = icmp eq i32 %Kx, 1                  ; [#uses=8 type=i1]
  %.0215.4 = select i1 %sel_tmp6, i128 %__Result__.11, i128 %sel_tmp5 ; [#uses=5 type=i128]
  %__Result__.1 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d0.V, i32 16, i32 31), !dbg !4407 ; [#uses=7 type=i16] [debug line = 941:81@1538:15@91:99@91:100@82:23]
  %__Result__.8.1 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d1.V, i32 16, i32 31), !dbg !4413 ; [#uses=6 type=i16] [debug line = 941:81@1538:15@91:99@91:100@83:23]
  %__Result__.9.1 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d2.V, i32 16, i32 31), !dbg !4419 ; [#uses=4 type=i16] [debug line = 941:81@1538:15@91:99@91:100@84:23]
  %__Result__.10.1 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d3.V, i32 16, i32 31), !dbg !4425 ; [#uses=2 type=i16] [debug line = 941:81@1538:15@91:99@91:100@85:23]
  %__Result__.11.1 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4, i16 %__Result__.1, i32 16, i32 31), !dbg !4426 ; [#uses=1 type=i128] [debug line = 958:115@89:16]
  %tmp.25.1 = icmp sgt i16 %__Result__.1, %__Result__.8.1, !dbg !4430 ; [#uses=1 type=i1] [debug line = 2050:5@90:45]
  %tmp.26.1 = select i1 %tmp.25.1, i16 %__Result__.1, i16 %__Result__.8.1, !dbg !4433 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@90:45]
  %__Result__.12.1 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4, i16 %tmp.26.1, i32 16, i32 31), !dbg !4436 ; [#uses=1 type=i128] [debug line = 958:115@90:45]
  %tmp.27.1 = icmp sgt i16 %__Result__.8.1, %__Result__.9.1, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tmp.28.1 = select i1 %tmp.27.1, i16 %__Result__.8.1, i16 %__Result__.9.1, !dbg !4437 ; [#uses=2 type=i16] [debug line = 2050:5@91:53]
  %tmp.29.1 = icmp sgt i16 %__Result__.1, %tmp.28.1, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tp_d0.V.2.1 = select i1 %tmp.29.1, i16 %__Result__.1, i16 %tmp.28.1, !dbg !4438 ; [#uses=1 type=i16] [debug line = 91:53]
  %__Result__.13.1 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4, i16 %tp_d0.V.2.1, i32 16, i32 31), !dbg !4440 ; [#uses=1 type=i128] [debug line = 958:115@91:88]
  %tmp.30.1 = icmp sgt i16 %__Result__.9.1, %__Result__.10.1, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tmp.31.1 = select i1 %tmp.30.1, i16 %__Result__.9.1, i16 %__Result__.10.1, !dbg !4442 ; [#uses=2 type=i16] [debug line = 2050:5@92:61]
  %tmp.32.1 = icmp sgt i16 %__Result__.8.1, %tmp.31.1, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tp_d1.V.2.1 = select i1 %tmp.32.1, i16 %__Result__.8.1, i16 %tmp.31.1, !dbg !4443 ; [#uses=2 type=i16] [debug line = 92:61]
  %tmp.33.1 = icmp sgt i16 %__Result__.1, %tp_d1.V.2.1, !dbg !4445 ; [#uses=1 type=i1] [debug line = 2050:5@92:96]
  %.in353.ld.1 = select i1 %tmp.33.1, i16 %__Result__.1, i16 %tp_d1.V.2.1, !dbg !4446 ; [#uses=1 type=i16] [debug line = 92:96]
  %__Result__.14.1 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4, i16 %.in353.ld.1, i32 16, i32 31), !dbg !4447 ; [#uses=1 type=i128] [debug line = 958:115@92:175]
  %sel_tmp9 = select i1 %sel_tmp, i128 %__Result__.14.1, i128 %.0215.4 ; [#uses=1 type=i128]
  %sel_tmp11 = select i1 %sel_tmp2, i128 %__Result__.13.1, i128 %sel_tmp9 ; [#uses=1 type=i128]
  %sel_tmp13 = select i1 %sel_tmp4, i128 %__Result__.12.1, i128 %sel_tmp11 ; [#uses=1 type=i128]
  %.0215.4.1 = select i1 %sel_tmp6, i128 %__Result__.11.1, i128 %sel_tmp13 ; [#uses=5 type=i128]
  %__Result__.2 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d0.V, i32 32, i32 47), !dbg !4407 ; [#uses=7 type=i16] [debug line = 941:81@1538:15@91:99@91:100@82:23]
  %__Result__.8.2 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d1.V, i32 32, i32 47), !dbg !4413 ; [#uses=6 type=i16] [debug line = 941:81@1538:15@91:99@91:100@83:23]
  %__Result__.9.2 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d2.V, i32 32, i32 47), !dbg !4419 ; [#uses=4 type=i16] [debug line = 941:81@1538:15@91:99@91:100@84:23]
  %__Result__.10.2 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d3.V, i32 32, i32 47), !dbg !4425 ; [#uses=2 type=i16] [debug line = 941:81@1538:15@91:99@91:100@85:23]
  %__Result__.11.2 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.1, i16 %__Result__.2, i32 32, i32 47), !dbg !4426 ; [#uses=1 type=i128] [debug line = 958:115@89:16]
  %tmp.25.2 = icmp sgt i16 %__Result__.2, %__Result__.8.2, !dbg !4430 ; [#uses=1 type=i1] [debug line = 2050:5@90:45]
  %tmp.26.2 = select i1 %tmp.25.2, i16 %__Result__.2, i16 %__Result__.8.2, !dbg !4433 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@90:45]
  %__Result__.12.2 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.1, i16 %tmp.26.2, i32 32, i32 47), !dbg !4436 ; [#uses=1 type=i128] [debug line = 958:115@90:45]
  %tmp.27.2 = icmp sgt i16 %__Result__.8.2, %__Result__.9.2, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tmp.28.2 = select i1 %tmp.27.2, i16 %__Result__.8.2, i16 %__Result__.9.2, !dbg !4437 ; [#uses=2 type=i16] [debug line = 2050:5@91:53]
  %tmp.29.2 = icmp sgt i16 %__Result__.2, %tmp.28.2, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tp_d0.V.2.2 = select i1 %tmp.29.2, i16 %__Result__.2, i16 %tmp.28.2, !dbg !4438 ; [#uses=1 type=i16] [debug line = 91:53]
  %__Result__.13.2 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.1, i16 %tp_d0.V.2.2, i32 32, i32 47), !dbg !4440 ; [#uses=1 type=i128] [debug line = 958:115@91:88]
  %tmp.30.2 = icmp sgt i16 %__Result__.9.2, %__Result__.10.2, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tmp.31.2 = select i1 %tmp.30.2, i16 %__Result__.9.2, i16 %__Result__.10.2, !dbg !4442 ; [#uses=2 type=i16] [debug line = 2050:5@92:61]
  %tmp.32.2 = icmp sgt i16 %__Result__.8.2, %tmp.31.2, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tp_d1.V.2.2 = select i1 %tmp.32.2, i16 %__Result__.8.2, i16 %tmp.31.2, !dbg !4443 ; [#uses=2 type=i16] [debug line = 92:61]
  %tmp.33.2 = icmp sgt i16 %__Result__.2, %tp_d1.V.2.2, !dbg !4445 ; [#uses=1 type=i1] [debug line = 2050:5@92:96]
  %.in353.ld.2 = select i1 %tmp.33.2, i16 %__Result__.2, i16 %tp_d1.V.2.2, !dbg !4446 ; [#uses=1 type=i16] [debug line = 92:96]
  %__Result__.14.2 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.1, i16 %.in353.ld.2, i32 32, i32 47), !dbg !4447 ; [#uses=1 type=i128] [debug line = 958:115@92:175]
  %sel_tmp17 = select i1 %sel_tmp, i128 %__Result__.14.2, i128 %.0215.4.1 ; [#uses=1 type=i128]
  %sel_tmp19 = select i1 %sel_tmp2, i128 %__Result__.13.2, i128 %sel_tmp17 ; [#uses=1 type=i128]
  %sel_tmp21 = select i1 %sel_tmp4, i128 %__Result__.12.2, i128 %sel_tmp19 ; [#uses=1 type=i128]
  %.0215.4.2 = select i1 %sel_tmp6, i128 %__Result__.11.2, i128 %sel_tmp21 ; [#uses=5 type=i128]
  %__Result__.3 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d0.V, i32 48, i32 63), !dbg !4407 ; [#uses=7 type=i16] [debug line = 941:81@1538:15@91:99@91:100@82:23]
  %__Result__.8.3 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d1.V, i32 48, i32 63), !dbg !4413 ; [#uses=6 type=i16] [debug line = 941:81@1538:15@91:99@91:100@83:23]
  %__Result__.9.3 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d2.V, i32 48, i32 63), !dbg !4419 ; [#uses=4 type=i16] [debug line = 941:81@1538:15@91:99@91:100@84:23]
  %__Result__.10.3 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d3.V, i32 48, i32 63), !dbg !4425 ; [#uses=2 type=i16] [debug line = 941:81@1538:15@91:99@91:100@85:23]
  %__Result__.11.3 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.2, i16 %__Result__.3, i32 48, i32 63), !dbg !4426 ; [#uses=1 type=i128] [debug line = 958:115@89:16]
  %tmp.25.3 = icmp sgt i16 %__Result__.3, %__Result__.8.3, !dbg !4430 ; [#uses=1 type=i1] [debug line = 2050:5@90:45]
  %tmp.26.3 = select i1 %tmp.25.3, i16 %__Result__.3, i16 %__Result__.8.3, !dbg !4433 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@90:45]
  %__Result__.12.3 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.2, i16 %tmp.26.3, i32 48, i32 63), !dbg !4436 ; [#uses=1 type=i128] [debug line = 958:115@90:45]
  %tmp.27.3 = icmp sgt i16 %__Result__.8.3, %__Result__.9.3, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tmp.28.3 = select i1 %tmp.27.3, i16 %__Result__.8.3, i16 %__Result__.9.3, !dbg !4437 ; [#uses=2 type=i16] [debug line = 2050:5@91:53]
  %tmp.29.3 = icmp sgt i16 %__Result__.3, %tmp.28.3, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tp_d0.V.2.3 = select i1 %tmp.29.3, i16 %__Result__.3, i16 %tmp.28.3, !dbg !4438 ; [#uses=1 type=i16] [debug line = 91:53]
  %__Result__.13.3 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.2, i16 %tp_d0.V.2.3, i32 48, i32 63), !dbg !4440 ; [#uses=1 type=i128] [debug line = 958:115@91:88]
  %tmp.30.3 = icmp sgt i16 %__Result__.9.3, %__Result__.10.3, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tmp.31.3 = select i1 %tmp.30.3, i16 %__Result__.9.3, i16 %__Result__.10.3, !dbg !4442 ; [#uses=2 type=i16] [debug line = 2050:5@92:61]
  %tmp.32.3 = icmp sgt i16 %__Result__.8.3, %tmp.31.3, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tp_d1.V.2.3 = select i1 %tmp.32.3, i16 %__Result__.8.3, i16 %tmp.31.3, !dbg !4443 ; [#uses=2 type=i16] [debug line = 92:61]
  %tmp.33.3 = icmp sgt i16 %__Result__.3, %tp_d1.V.2.3, !dbg !4445 ; [#uses=1 type=i1] [debug line = 2050:5@92:96]
  %.in353.ld.3 = select i1 %tmp.33.3, i16 %__Result__.3, i16 %tp_d1.V.2.3, !dbg !4446 ; [#uses=1 type=i16] [debug line = 92:96]
  %__Result__.14.3 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.2, i16 %.in353.ld.3, i32 48, i32 63), !dbg !4447 ; [#uses=1 type=i128] [debug line = 958:115@92:175]
  %sel_tmp25 = select i1 %sel_tmp, i128 %__Result__.14.3, i128 %.0215.4.2 ; [#uses=1 type=i128]
  %sel_tmp27 = select i1 %sel_tmp2, i128 %__Result__.13.3, i128 %sel_tmp25 ; [#uses=1 type=i128]
  %sel_tmp28 = select i1 %sel_tmp4, i128 %__Result__.12.3, i128 %sel_tmp27 ; [#uses=1 type=i128]
  %.0215.4.3 = select i1 %sel_tmp6, i128 %__Result__.11.3, i128 %sel_tmp28 ; [#uses=5 type=i128]
  %__Result__.4 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d0.V, i32 64, i32 79), !dbg !4407 ; [#uses=7 type=i16] [debug line = 941:81@1538:15@91:99@91:100@82:23]
  %__Result__.8.4 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d1.V, i32 64, i32 79), !dbg !4413 ; [#uses=6 type=i16] [debug line = 941:81@1538:15@91:99@91:100@83:23]
  %__Result__.9.4 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d2.V, i32 64, i32 79), !dbg !4419 ; [#uses=4 type=i16] [debug line = 941:81@1538:15@91:99@91:100@84:23]
  %__Result__.10.4 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d3.V, i32 64, i32 79), !dbg !4425 ; [#uses=2 type=i16] [debug line = 941:81@1538:15@91:99@91:100@85:23]
  %__Result__.11.4 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.3, i16 %__Result__.4, i32 64, i32 79), !dbg !4426 ; [#uses=1 type=i128] [debug line = 958:115@89:16]
  %tmp.25.4 = icmp sgt i16 %__Result__.4, %__Result__.8.4, !dbg !4430 ; [#uses=1 type=i1] [debug line = 2050:5@90:45]
  %tmp.26.4 = select i1 %tmp.25.4, i16 %__Result__.4, i16 %__Result__.8.4, !dbg !4433 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@90:45]
  %__Result__.12.4 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.3, i16 %tmp.26.4, i32 64, i32 79), !dbg !4436 ; [#uses=1 type=i128] [debug line = 958:115@90:45]
  %tmp.27.4 = icmp sgt i16 %__Result__.8.4, %__Result__.9.4, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tmp.28.4 = select i1 %tmp.27.4, i16 %__Result__.8.4, i16 %__Result__.9.4, !dbg !4437 ; [#uses=2 type=i16] [debug line = 2050:5@91:53]
  %tmp.29.4 = icmp sgt i16 %__Result__.4, %tmp.28.4, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tp_d0.V.2.4 = select i1 %tmp.29.4, i16 %__Result__.4, i16 %tmp.28.4, !dbg !4438 ; [#uses=1 type=i16] [debug line = 91:53]
  %__Result__.13.4 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.3, i16 %tp_d0.V.2.4, i32 64, i32 79), !dbg !4440 ; [#uses=1 type=i128] [debug line = 958:115@91:88]
  %tmp.30.4 = icmp sgt i16 %__Result__.9.4, %__Result__.10.4, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tmp.31.4 = select i1 %tmp.30.4, i16 %__Result__.9.4, i16 %__Result__.10.4, !dbg !4442 ; [#uses=2 type=i16] [debug line = 2050:5@92:61]
  %tmp.32.4 = icmp sgt i16 %__Result__.8.4, %tmp.31.4, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tp_d1.V.2.4 = select i1 %tmp.32.4, i16 %__Result__.8.4, i16 %tmp.31.4, !dbg !4443 ; [#uses=2 type=i16] [debug line = 92:61]
  %tmp.33.4 = icmp sgt i16 %__Result__.4, %tp_d1.V.2.4, !dbg !4445 ; [#uses=1 type=i1] [debug line = 2050:5@92:96]
  %.in353.ld.4 = select i1 %tmp.33.4, i16 %__Result__.4, i16 %tp_d1.V.2.4, !dbg !4446 ; [#uses=1 type=i16] [debug line = 92:96]
  %__Result__.14.4 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.3, i16 %.in353.ld.4, i32 64, i32 79), !dbg !4447 ; [#uses=1 type=i128] [debug line = 958:115@92:175]
  %sel_tmp29 = select i1 %sel_tmp, i128 %__Result__.14.4, i128 %.0215.4.3 ; [#uses=1 type=i128]
  %sel_tmp30 = select i1 %sel_tmp2, i128 %__Result__.13.4, i128 %sel_tmp29 ; [#uses=1 type=i128]
  %sel_tmp31 = select i1 %sel_tmp4, i128 %__Result__.12.4, i128 %sel_tmp30 ; [#uses=1 type=i128]
  %.0215.4.4 = select i1 %sel_tmp6, i128 %__Result__.11.4, i128 %sel_tmp31 ; [#uses=5 type=i128]
  %__Result__.5 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d0.V, i32 80, i32 95), !dbg !4407 ; [#uses=7 type=i16] [debug line = 941:81@1538:15@91:99@91:100@82:23]
  %__Result__.8.5 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d1.V, i32 80, i32 95), !dbg !4413 ; [#uses=6 type=i16] [debug line = 941:81@1538:15@91:99@91:100@83:23]
  %__Result__.9.5 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d2.V, i32 80, i32 95), !dbg !4419 ; [#uses=4 type=i16] [debug line = 941:81@1538:15@91:99@91:100@84:23]
  %__Result__.10.5 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d3.V, i32 80, i32 95), !dbg !4425 ; [#uses=2 type=i16] [debug line = 941:81@1538:15@91:99@91:100@85:23]
  %__Result__.11.5 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.4, i16 %__Result__.5, i32 80, i32 95), !dbg !4426 ; [#uses=1 type=i128] [debug line = 958:115@89:16]
  %tmp.25.5 = icmp sgt i16 %__Result__.5, %__Result__.8.5, !dbg !4430 ; [#uses=1 type=i1] [debug line = 2050:5@90:45]
  %tmp.26.5 = select i1 %tmp.25.5, i16 %__Result__.5, i16 %__Result__.8.5, !dbg !4433 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@90:45]
  %__Result__.12.5 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.4, i16 %tmp.26.5, i32 80, i32 95), !dbg !4436 ; [#uses=1 type=i128] [debug line = 958:115@90:45]
  %tmp.27.5 = icmp sgt i16 %__Result__.8.5, %__Result__.9.5, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tmp.28.5 = select i1 %tmp.27.5, i16 %__Result__.8.5, i16 %__Result__.9.5, !dbg !4437 ; [#uses=2 type=i16] [debug line = 2050:5@91:53]
  %tmp.29.5 = icmp sgt i16 %__Result__.5, %tmp.28.5, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tp_d0.V.2.5 = select i1 %tmp.29.5, i16 %__Result__.5, i16 %tmp.28.5, !dbg !4438 ; [#uses=1 type=i16] [debug line = 91:53]
  %__Result__.13.5 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.4, i16 %tp_d0.V.2.5, i32 80, i32 95), !dbg !4440 ; [#uses=1 type=i128] [debug line = 958:115@91:88]
  %tmp.30.5 = icmp sgt i16 %__Result__.9.5, %__Result__.10.5, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tmp.31.5 = select i1 %tmp.30.5, i16 %__Result__.9.5, i16 %__Result__.10.5, !dbg !4442 ; [#uses=2 type=i16] [debug line = 2050:5@92:61]
  %tmp.32.5 = icmp sgt i16 %__Result__.8.5, %tmp.31.5, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tp_d1.V.2.5 = select i1 %tmp.32.5, i16 %__Result__.8.5, i16 %tmp.31.5, !dbg !4443 ; [#uses=2 type=i16] [debug line = 92:61]
  %tmp.33.5 = icmp sgt i16 %__Result__.5, %tp_d1.V.2.5, !dbg !4445 ; [#uses=1 type=i1] [debug line = 2050:5@92:96]
  %.in353.ld.5 = select i1 %tmp.33.5, i16 %__Result__.5, i16 %tp_d1.V.2.5, !dbg !4446 ; [#uses=1 type=i16] [debug line = 92:96]
  %__Result__.14.5 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.4, i16 %.in353.ld.5, i32 80, i32 95), !dbg !4447 ; [#uses=1 type=i128] [debug line = 958:115@92:175]
  %sel_tmp32 = select i1 %sel_tmp, i128 %__Result__.14.5, i128 %.0215.4.4 ; [#uses=1 type=i128]
  %sel_tmp33 = select i1 %sel_tmp2, i128 %__Result__.13.5, i128 %sel_tmp32 ; [#uses=1 type=i128]
  %sel_tmp34 = select i1 %sel_tmp4, i128 %__Result__.12.5, i128 %sel_tmp33 ; [#uses=1 type=i128]
  %.0215.4.5 = select i1 %sel_tmp6, i128 %__Result__.11.5, i128 %sel_tmp34 ; [#uses=5 type=i128]
  %__Result__.6 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d0.V, i32 96, i32 111), !dbg !4407 ; [#uses=7 type=i16] [debug line = 941:81@1538:15@91:99@91:100@82:23]
  %__Result__.8.6 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d1.V, i32 96, i32 111), !dbg !4413 ; [#uses=6 type=i16] [debug line = 941:81@1538:15@91:99@91:100@83:23]
  %__Result__.9.6 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d2.V, i32 96, i32 111), !dbg !4419 ; [#uses=4 type=i16] [debug line = 941:81@1538:15@91:99@91:100@84:23]
  %__Result__.10.6 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d3.V, i32 96, i32 111), !dbg !4425 ; [#uses=2 type=i16] [debug line = 941:81@1538:15@91:99@91:100@85:23]
  %__Result__.11.6 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.5, i16 %__Result__.6, i32 96, i32 111), !dbg !4426 ; [#uses=1 type=i128] [debug line = 958:115@89:16]
  %tmp.25.6 = icmp sgt i16 %__Result__.6, %__Result__.8.6, !dbg !4430 ; [#uses=1 type=i1] [debug line = 2050:5@90:45]
  %tmp.26.6 = select i1 %tmp.25.6, i16 %__Result__.6, i16 %__Result__.8.6, !dbg !4433 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@90:45]
  %__Result__.12.6 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.5, i16 %tmp.26.6, i32 96, i32 111), !dbg !4436 ; [#uses=1 type=i128] [debug line = 958:115@90:45]
  %tmp.27.6 = icmp sgt i16 %__Result__.8.6, %__Result__.9.6, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tmp.28.6 = select i1 %tmp.27.6, i16 %__Result__.8.6, i16 %__Result__.9.6, !dbg !4437 ; [#uses=2 type=i16] [debug line = 2050:5@91:53]
  %tmp.29.6 = icmp sgt i16 %__Result__.6, %tmp.28.6, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tp_d0.V.2.6 = select i1 %tmp.29.6, i16 %__Result__.6, i16 %tmp.28.6, !dbg !4438 ; [#uses=1 type=i16] [debug line = 91:53]
  %__Result__.13.6 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.5, i16 %tp_d0.V.2.6, i32 96, i32 111), !dbg !4440 ; [#uses=1 type=i128] [debug line = 958:115@91:88]
  %tmp.30.6 = icmp sgt i16 %__Result__.9.6, %__Result__.10.6, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tmp.31.6 = select i1 %tmp.30.6, i16 %__Result__.9.6, i16 %__Result__.10.6, !dbg !4442 ; [#uses=2 type=i16] [debug line = 2050:5@92:61]
  %tmp.32.6 = icmp sgt i16 %__Result__.8.6, %tmp.31.6, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tp_d1.V.2.6 = select i1 %tmp.32.6, i16 %__Result__.8.6, i16 %tmp.31.6, !dbg !4443 ; [#uses=2 type=i16] [debug line = 92:61]
  %tmp.33.6 = icmp sgt i16 %__Result__.6, %tp_d1.V.2.6, !dbg !4445 ; [#uses=1 type=i1] [debug line = 2050:5@92:96]
  %.in353.ld.6 = select i1 %tmp.33.6, i16 %__Result__.6, i16 %tp_d1.V.2.6, !dbg !4446 ; [#uses=1 type=i16] [debug line = 92:96]
  %__Result__.14.6 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.5, i16 %.in353.ld.6, i32 96, i32 111), !dbg !4447 ; [#uses=1 type=i128] [debug line = 958:115@92:175]
  %sel_tmp35 = select i1 %sel_tmp, i128 %__Result__.14.6, i128 %.0215.4.5 ; [#uses=1 type=i128]
  %sel_tmp36 = select i1 %sel_tmp2, i128 %__Result__.13.6, i128 %sel_tmp35 ; [#uses=1 type=i128]
  %sel_tmp37 = select i1 %sel_tmp4, i128 %__Result__.12.6, i128 %sel_tmp36 ; [#uses=1 type=i128]
  %.0215.4.6 = select i1 %sel_tmp6, i128 %__Result__.11.6, i128 %sel_tmp37 ; [#uses=5 type=i128]
  %__Result__.7 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d0.V, i32 112, i32 127), !dbg !4407 ; [#uses=7 type=i16] [debug line = 941:81@1538:15@91:99@91:100@82:23]
  %__Result__.8.7 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d1.V, i32 112, i32 127), !dbg !4413 ; [#uses=6 type=i16] [debug line = 941:81@1538:15@91:99@91:100@83:23]
  %__Result__.9.7 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d2.V, i32 112, i32 127), !dbg !4419 ; [#uses=4 type=i16] [debug line = 941:81@1538:15@91:99@91:100@84:23]
  %__Result__.10.7 = call i16 @_ssdm_op_PartSelect.i16.i128.i32.i32(i128 %in_d3.V, i32 112, i32 127), !dbg !4425 ; [#uses=2 type=i16] [debug line = 941:81@1538:15@91:99@91:100@85:23]
  %__Result__.11.7 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.6, i16 %__Result__.7, i32 112, i32 127), !dbg !4426 ; [#uses=1 type=i128] [debug line = 958:115@89:16]
  %tmp.25.7 = icmp sgt i16 %__Result__.7, %__Result__.8.7, !dbg !4430 ; [#uses=1 type=i1] [debug line = 2050:5@90:45]
  %tmp.26.7 = select i1 %tmp.25.7, i16 %__Result__.7, i16 %__Result__.8.7, !dbg !4433 ; [#uses=1 type=i16] [debug line = 2448:93@2448:109@957:39@90:45]
  %__Result__.12.7 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.6, i16 %tmp.26.7, i32 112, i32 127), !dbg !4436 ; [#uses=1 type=i128] [debug line = 958:115@90:45]
  %tmp.27.7 = icmp sgt i16 %__Result__.8.7, %__Result__.9.7, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tmp.28.7 = select i1 %tmp.27.7, i16 %__Result__.8.7, i16 %__Result__.9.7, !dbg !4437 ; [#uses=2 type=i16] [debug line = 2050:5@91:53]
  %tmp.29.7 = icmp sgt i16 %__Result__.7, %tmp.28.7, !dbg !4437 ; [#uses=1 type=i1] [debug line = 2050:5@91:53]
  %tp_d0.V.2.7 = select i1 %tmp.29.7, i16 %__Result__.7, i16 %tmp.28.7, !dbg !4438 ; [#uses=1 type=i16] [debug line = 91:53]
  %__Result__.13.7 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.6, i16 %tp_d0.V.2.7, i32 112, i32 127), !dbg !4440 ; [#uses=1 type=i128] [debug line = 958:115@91:88]
  %tmp.30.7 = icmp sgt i16 %__Result__.9.7, %__Result__.10.7, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tmp.31.7 = select i1 %tmp.30.7, i16 %__Result__.9.7, i16 %__Result__.10.7, !dbg !4442 ; [#uses=2 type=i16] [debug line = 2050:5@92:61]
  %tmp.32.7 = icmp sgt i16 %__Result__.8.7, %tmp.31.7, !dbg !4442 ; [#uses=1 type=i1] [debug line = 2050:5@92:61]
  %tp_d1.V.2.7 = select i1 %tmp.32.7, i16 %__Result__.8.7, i16 %tmp.31.7, !dbg !4443 ; [#uses=2 type=i16] [debug line = 92:61]
  %tmp.33.7 = icmp sgt i16 %__Result__.7, %tp_d1.V.2.7, !dbg !4445 ; [#uses=1 type=i1] [debug line = 2050:5@92:96]
  %.in353.ld.7 = select i1 %tmp.33.7, i16 %__Result__.7, i16 %tp_d1.V.2.7, !dbg !4446 ; [#uses=1 type=i16] [debug line = 92:96]
  %__Result__.14.7 = call i128 @llvm.part.set.i128.i16(i128 %.0215.4.6, i16 %.in353.ld.7, i32 112, i32 127), !dbg !4447 ; [#uses=1 type=i128] [debug line = 958:115@92:175]
  %sel_tmp38 = select i1 %sel_tmp, i128 %__Result__.14.7, i128 %.0215.4.6, !dbg !4449 ; [#uses=1 type=i128] [debug line = 145:31@95:6]
  %sel_tmp39 = select i1 %sel_tmp2, i128 %__Result__.13.7, i128 %sel_tmp38, !dbg !4449 ; [#uses=1 type=i128] [debug line = 145:31@95:6]
  %sel_tmp40 = select i1 %sel_tmp4, i128 %__Result__.12.7, i128 %sel_tmp39, !dbg !4449 ; [#uses=1 type=i128] [debug line = 145:31@95:6]
  %tmp.V.5 = select i1 %sel_tmp6, i128 %__Result__.11.7, i128 %sel_tmp40, !dbg !4449 ; [#uses=2 type=i128] [debug line = 145:31@95:6]
  call void @llvm.dbg.value(metadata !{i128* %out.V.V}, i64 0, metadata !4322), !dbg !4451 ; [debug line = 144:48@95:6] [debug variable = stream<ap_int<128> >.V.V]
  call void @llvm.dbg.declare(metadata !{i128* %tmp.V}, metadata !4325), !dbg !4452 ; [debug line = 145:22@95:6] [debug variable = tmp.V]
  call void @llvm.dbg.value(metadata !{i128 %tmp.V.5}, i64 0, metadata !4325), !dbg !4449 ; [debug line = 145:31@95:6] [debug variable = tmp.V]
  call void @llvm.dbg.value(metadata !{i128 %tmp.V.5}, i64 0, metadata !4325), !dbg !4449 ; [debug line = 145:31@95:6] [debug variable = tmp.V]
  store i128 %tmp.V.5, i128* %tmp.V, align 16, !dbg !4449 ; [debug line = 145:31@95:6]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_int.2 = type { %struct.ap_int_base.1 }P.%struct.ap_int.2 = type { %struct.ap_int_base.1 }P"(i128* %out.V.V, i128* %tmp.V), !dbg !4453 ; [debug line = 146:9@95:6]
  br label %._crit_edge, !dbg !4454               ; [debug line = 96:5]

._crit_edge:                                      ; preds = %.preheader.0_ifconv, %6
  %.0215.5 = phi i128 [ %tmp.V.5, %.preheader.0_ifconv ], [ %.0215.2, %6 ] ; [#uses=1 type=i128]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str8, i32 %tmp.18), !dbg !4455 ; [#uses=0 type=i32] [debug line = 97:4]
  call void @llvm.dbg.value(metadata !{i31 %j.2}, i64 0, metadata !4456), !dbg !4457 ; [debug line = 69:25] [debug variable = j]
  br label %5, !dbg !4457                         ; [debug line = 69:25]
...
; <label>:8                                       ; preds = %5
  ...
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str7, i32 %tmp.17), !dbg !4458 ; [#uses=0 type=i32] [debug line = 98:3]
  %i.2 = add i31 %i, 1, !dbg !4459                ; [#uses=1 type=i31] [debug line = 66:26]
  call void @llvm.dbg.value(metadata !{i31 %i.2}, i64 0, metadata !4460), !dbg !4459 ; [debug line = 66:26] [debug variable = i]
  br label %3, !dbg !4459                         ; [debug line = 66:26]
...
; <label>:10                                      ; preds = %3
  ...
  %11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str6, i32 %tmp.16), !dbg !4461 ; [#uses=0 type=i32] [debug line = 99:2]
  %c.2 = add i31 %c, 1, !dbg !4462                ; [#uses=1 type=i31] [debug line = 63:25]
  call void @llvm.dbg.value(metadata !{i31 %c.2}, i64 0, metadata !4463), !dbg !4462 ; [debug line = 63:25] [debug variable = c]
  br label %1, !dbg !4462                         ; [debug line = 63:25]

; <label>:12                                      ; preds = %1
  ret void, !dbg !4464                            ; [debug line = 100:1]
}
...
define void @pool(i128* %in.V.V, i128* %out.V.data.V, i1* %out.V.last, i32 %ch_div_K, i32 %height_in, i32 %width_in, i32 %height_out, i32 %width_out, i32 %Kx, i32 %Ky) {
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, [1 x i8]* @.str1) nounwind, !dbg !4465 ; [debug line = 16:1]
  call void (...)* @_ssdm_op_SpecBitsMap(i128* %in.V.V), !map !4467
  call void (...)* @_ssdm_op_SpecBitsMap(i128* %out.V.data.V), !map !4471
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %out.V.last), !map !4475
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %ch_div_K), !map !4479
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %height_in), !map !4485
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %width_in), !map !4489
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %height_out), !map !4493
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %width_out), !map !4497
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %Kx), !map !4501
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %Ky), !map !4505
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4509 ; [debug line = 7:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %Ky, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4510 ; [debug line = 8:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %width_in, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4511 ; [debug line = 9:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %Kx, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4512 ; [debug line = 10:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %height_in, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4513 ; [debug line = 11:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %height_out, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4514 ; [debug line = 12:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %width_out, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4515 ; [debug line = 13:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %ch_div_K, [10 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4516 ; [debug line = 14:1]
  call void (...)* @_ssdm_op_SpecInterface(i128* %out.V.data.V, i1* %out.V.last, [5 x i8]* @.str2, i32 1, i32 1, [5 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4517 ; [debug line = 17:1]
  call void (...)* @_ssdm_op_SpecInterface(i128* %in.V.V, [5 x i8]* @.str2, i32 1, i32 1, [5 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4518 ; [debug line = 18:1]
  call void @llvm.dbg.value(metadata !{i128* %in.V.V}, i64 0, metadata !4519), !dbg !4521 ; [debug line = 3:35] [debug variable = in.V.V]
  call void @llvm.dbg.value(metadata !{i128* %out.V.data.V}, i64 0, metadata !4522), !dbg !4528 ; [debug line = 3:65] [debug variable = out.V.data.V]
  call void @llvm.dbg.value(metadata !{i1* %out.V.last}, i64 0, metadata !4529), !dbg !4528 ; [debug line = 3:65] [debug variable = out.V.last]
  call void @llvm.dbg.value(metadata !{i32 %ch_div_K}, i64 0, metadata !4535), !dbg !4536 ; [debug line = 4:7] [debug variable = ch_div_K]
  call void @llvm.dbg.value(metadata !{i32 %height_in}, i64 0, metadata !4537), !dbg !4538 ; [debug line = 4:20] [debug variable = height_in]
  call void @llvm.dbg.value(metadata !{i32 %width_in}, i64 0, metadata !4539), !dbg !4540 ; [debug line = 4:34] [debug variable = width_in]
  call void @llvm.dbg.value(metadata !{i32 %height_out}, i64 0, metadata !4541), !dbg !4542 ; [debug line = 5:7] [debug variable = height_out]
  call void @llvm.dbg.value(metadata !{i32 %width_out}, i64 0, metadata !4543), !dbg !4544 ; [debug line = 5:22] [debug variable = width_out]
  call void @llvm.dbg.value(metadata !{i32 %Kx}, i64 0, metadata !4545), !dbg !4546 ; [debug line = 5:36] [debug variable = Kx]
  call void @llvm.dbg.value(metadata !{i32 %Ky}, i64 0, metadata !4547), !dbg !4548 ; [debug line = 5:43] [debug variable = Ky]
  call void @llvm.dbg.declare(metadata !{i128* %stream_tp.V.V}, metadata !4549), !dbg !4551 ; [debug line = 20:25] [debug variable = stream_tp.V.V]
  call void @llvm.dbg.declare(metadata !{i128* %stream_tp2.V.V}, metadata !4552), !dbg !4554 ; [debug line = 23:25] [debug variable = stream_tp2.V.V]
  call fastcc void @pool_1D(i128* %in.V.V, i128* %stream_tp.V.V, i32 %ch_div_K, i32 %height_in, i32 %width_in, i32 %Kx), !dbg !4555 ; [debug line = 25:2]
  call fastcc void @pool_2D(i128* %stream_tp.V.V, i128* %stream_tp2.V.V, i32 %ch_div_K, i32 %height_in, i32 %width_out, i32 %Ky), !dbg !4556 ; [debug line = 26:2]
  call fastcc void @hs2axis(i128* %stream_tp2.V.V, i128* %out.V.data.V, i1* %out.V.last, i32 %ch_div_K, i32 %height_out, i32 %width_out), !dbg !4557 ; [debug line = 27:2]
  ret void, !dbg !4558                            ; [debug line = 28:1]
}
...
define internal fastcc void @hs2axis(i128* %in.V.V, i128* %out.V.data.V, i1* %out.V.last, i32 %ch_div_K, i32 %height_out, i32 %width_out) {
  ...
  %tmp.V = alloca i128, align 8                   ; [#uses=2 type=i128*]
  call void @llvm.dbg.value(metadata !{i128* %in.V.V}, i64 0, metadata !4559), !dbg !4561 ; [debug line = 30:38] [debug variable = in.V.V]
  call void @llvm.dbg.value(metadata !{i128* %out.V.data.V}, i64 0, metadata !4562), !dbg !4564 ; [debug line = 30:68] [debug variable = out.V.data.V]
  call void @llvm.dbg.value(metadata !{i1* %out.V.last}, i64 0, metadata !4565), !dbg !4564 ; [debug line = 30:68] [debug variable = out.V.last]
  call void @llvm.dbg.value(metadata !{i32 %ch_div_K}, i64 0, metadata !4566), !dbg !4567 ; [debug line = 30:76] [debug variable = ch_div_K]
  call void @llvm.dbg.value(metadata !{i32 %height_out}, i64 0, metadata !4568), !dbg !4569 ; [debug line = 30:89] [debug variable = height_out]
  call void @llvm.dbg.value(metadata !{i32 %width_out}, i64 0, metadata !4570), !dbg !4571 ; [debug line = 30:104] [debug variable = width_out]
  call void (...)* @_ssdm_op_SpecInterface(i32 %height_out, [10 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4572 ; [debug line = 32:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %width_out, [10 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4574 ; [debug line = 33:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %ch_div_K, [10 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !4575 ; [debug line = 34:1]
  %tmp1 = mul i32 %width_out, %ch_div_K, !dbg !4576 ; [#uses=1 type=i32] [debug line = 36:13]
  %tmp. = mul i32 %tmp1, %height_out, !dbg !4576  ; [#uses=2 type=i32] [debug line = 36:13]
  %tmp.16 = add nsw i32 %tmp., -1, !dbg !4578     ; [#uses=1 type=i32] [debug line = 43:3]
  br label %1, !dbg !4576                         ; [debug line = 36:13]

; <label>:1                                       ; preds = %2, %0
  %i = phi i31 [ 0, %0 ], [ %i.3, %2 ]            ; [#uses=2 type=i31]
  %i.cast = zext i31 %i to i32, !dbg !4576        ; [#uses=2 type=i32] [debug line = 36:13]
  %tmp.17 = icmp slt i32 %i.cast, %tmp., !dbg !4576 ; [#uses=1 type=i1] [debug line = 36:13]
  br i1 %tmp.17, label %2, label %4, !dbg !4576   ; [debug line = 36:13]

; <label>:2                                       ; preds = %1
  %tmp.19 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str5), !dbg !4580 ; [#uses=1 type=i32] [debug line = 37:3]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !4581 ; [debug line = 38:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 200, i32 200, [1 x i8]* @.str1) nounwind, !dbg !4582 ; [debug line = 39:1]
  call void @llvm.dbg.value(metadata !{i128* %in.V.V}, i64 0, metadata !4219), !dbg !4583 ; [debug line = 129:56@42:11] [debug variable = stream<ap_int<128> >.V.V]
  call void @llvm.dbg.declare(metadata !{i128* %tmp.V}, metadata !4225), !dbg !4585 ; [debug line = 130:22@42:11] [debug variable = tmp.V]
  call void @"_ssdm_op_IfRead.Stream.%struct.ap_int.2 = type { %struct.ap_int_base.1 }P.%struct.ap_int.2 = type { %struct.ap_int_base.1 }P"(i128* %in.V.V, i128* %tmp.V), !dbg !4586 ; [debug line = 131:9@42:11]
  call void @llvm.dbg.value(metadata !{i128* %tmp.V}, i64 0, metadata !4230), !dbg !4587 ; [debug line = 173:82@42:11] [debug variable = op2.V]
  call void @llvm.dbg.value(metadata !{i128* %tmp.V}, i64 0, metadata !4225), !dbg !4588 ; [debug line = 174:5@42:11] [debug variable = tmp.V]
  call void @llvm.dbg.value(metadata !{i128* %tmp.V}, i64 0, metadata !4225), !dbg !4588 ; [debug line = 174:5@42:11] [debug variable = tmp.V]
  %tp.data.V = load i128* %tmp.V, align 16, !dbg !4588 ; [#uses=1 type=i128] [debug line = 174:5@42:11]
  call void @llvm.dbg.value(metadata !{i128 %tp.data.V}, i64 0, metadata !4589), !dbg !4588 ; [debug line = 174:5@42:11] [debug variable = tp.data.V]
  %tmp.last.1 = icmp eq i32 %i.cast, %tmp.16, !dbg !4578 ; [#uses=1 type=i1] [debug line = 43:3]
  call void @llvm.dbg.value(metadata !{i128* %out.V.data.V}, i64 0, metadata !4592), !dbg !4596 ; [debug line = 144:48@47:3] [debug variable = stream<dtype_stream>.V.data.V]
  call void @llvm.dbg.value(metadata !{i1* %out.V.last}, i64 0, metadata !4598), !dbg !4596 ; [debug line = 144:48@47:3] [debug variable = stream<dtype_stream>.V.last]
  call void @llvm.dbg.declare(metadata !{i128* %tmp.data.V}, metadata !4600), !dbg !4603 ; [debug line = 145:22@47:3] [debug variable = tmp.data.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.last}, metadata !4604), !dbg !4603 ; [debug line = 145:22@47:3] [debug variable = tmp.last]
  call void @llvm.dbg.value(metadata !{i128 %tp.data.V}, i64 0, metadata !4600), !dbg !4605 ; [debug line = 145:31@47:3] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i128 %tp.data.V}, i64 0, metadata !4600), !dbg !4605 ; [debug line = 145:31@47:3] [debug variable = tmp.data.V]
  store i128 %tp.data.V, i128* %tmp.data.V, align 16, !dbg !4605 ; [debug line = 145:31@47:3]
  call void @llvm.dbg.value(metadata !{i1 %tmp.last.1}, i64 0, metadata !4604), !dbg !4605 ; [debug line = 145:31@47:3] [debug variable = tmp.last]
  call void @llvm.dbg.value(metadata !{i1 %tmp.last.1}, i64 0, metadata !4604), !dbg !4605 ; [debug line = 145:31@47:3] [debug variable = tmp.last]
  store i1 %tmp.last.1, i1* %tmp.last, align 16, !dbg !4605 ; [debug line = 145:31@47:3]
  call void @"_ssdm_op_IfWrite.Stream.%struct.dtype_stream.4 = type { %struct.ap_int.2, i1 }P.%struct.dtype_stream.4 = type { %struct.ap_int.2, i1 }P"(i128* %out.V.data.V, i1* %out.V.last, i128* %tmp.data.V, i1* %tmp.last), !dbg !4606 ; [debug line = 146:9@47:3]
  %3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str5, i32 %tmp.19), !dbg !4607 ; [#uses=0 type=i32] [debug line = 48:2]
  %i.3 = add i31 %i, 1, !dbg !4608                ; [#uses=1 type=i31] [debug line = 36:46]
  call void @llvm.dbg.value(metadata !{i31 %i.3}, i64 0, metadata !4609), !dbg !4608 ; [debug line = 36:46] [debug variable = i]
  br label %1, !dbg !4608                         ; [debug line = 36:46]

; <label>:4                                       ; preds = %1
  ret void, !dbg !4610                            ; [debug line = 49:1]
}
...
!4292 = metadata !{i32 958, i32 115, metadata !4293, metadata !4295}
!4293 = metadata !{i32 786443, metadata !4294, i32 958, i32 15, metadata !875, i32 37} ; [ DW_TAG_lexical_block ]
!4294 = metadata !{i32 786443, metadata !2194, i32 956, i32 106, metadata !875, i32 36} ; [ DW_TAG_lexical_block ]
!4295 = metadata !{i32 165, i32 16, metadata !4296, null}
!4296 = metadata !{i32 786443, metadata !4297, i32 165, i32 15, metadata !886, i32 30} ; [ DW_TAG_lexical_block ]
!4297 = metadata !{i32 786443, metadata !4271, i32 164, i32 7, metadata !886, i32 29} ; [ DW_TAG_lexical_block ]
!4298 = metadata !{i32 2050, i32 5, metadata !4299, metadata !4300}
!4299 = metadata !{i32 786443, metadata !2193, i32 2049, i32 104, metadata !875, i32 35} ; [ DW_TAG_lexical_block ]
!4300 = metadata !{i32 166, i32 45, metadata !4301, null}
!4301 = metadata !{i32 786443, metadata !4297, i32 166, i32 15, metadata !886, i32 31} ; [ DW_TAG_lexical_block ]
!4302 = metadata !{i32 2448, i32 93, metadata !4303, metadata !4304}
!4303 = metadata !{i32 786443, metadata !2198, i32 2448, i32 91, metadata !875, i32 38} ; [ DW_TAG_lexical_block ]
!4304 = metadata !{i32 2448, i32 109, metadata !2195, metadata !4305}
!4305 = metadata !{i32 957, i32 39, metadata !4294, metadata !4300}
!4306 = metadata !{i32 958, i32 115, metadata !4293, metadata !4300}
!4307 = metadata !{i32 2050, i32 5, metadata !4299, metadata !4308}
!4308 = metadata !{i32 167, i32 53, metadata !4309, null}
!4309 = metadata !{i32 786443, metadata !4297, i32 167, i32 15, metadata !886, i32 32} ; [ DW_TAG_lexical_block ]
!4310 = metadata !{i32 958, i32 115, metadata !4293, metadata !4311}
!4311 = metadata !{i32 167, i32 88, metadata !4309, null}
!4312 = metadata !{i32 2050, i32 5, metadata !4299, metadata !4313}
!4313 = metadata !{i32 168, i32 61, metadata !4314, null}
!4314 = metadata !{i32 786443, metadata !4297, i32 168, i32 15, metadata !886, i32 33} ; [ DW_TAG_lexical_block ]
!4315 = metadata !{i32 2050, i32 5, metadata !4299, metadata !4316}
!4316 = metadata !{i32 168, i32 96, metadata !4314, null}
!4317 = metadata !{i32 958, i32 115, metadata !4293, metadata !4318}
!4318 = metadata !{i32 168, i32 175, metadata !4314, null}
!4319 = metadata !{i32 145, i32 31, metadata !4320, metadata !4321}
!4320 = metadata !{i32 786443, metadata !2192, i32 144, i32 79, metadata !892, i32 34} ; [ DW_TAG_lexical_block ]
!4321 = metadata !{i32 171, i32 6, metadata !4200, null}
!4322 = metadata !{i32 790531, metadata !4323, metadata !"stream<ap_int<128> >.V.V", null, i32 144, metadata !4222, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4323 = metadata !{i32 786689, metadata !2192, metadata !"this", metadata !892, i32 16777360, metadata !4221, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4324 = metadata !{i32 144, i32 48, metadata !2192, metadata !4321}
!4325 = metadata !{i32 790529, metadata !4326, metadata !"tmp.V", null, i32 145, metadata !4171, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4326 = metadata !{i32 786688, metadata !4320, metadata !"tmp", metadata !892, i32 145, metadata !895, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4327 = metadata !{i32 145, i32 22, metadata !4320, metadata !4321}
!4328 = metadata !{i32 146, i32 9, metadata !4320, metadata !4321}
!4329 = metadata !{i32 172, i32 5, metadata !4200, null}
!4330 = metadata !{i32 174, i32 5, metadata !4201, null}
!4331 = metadata !{i32 177, i32 6, metadata !4201, null}
!4332 = metadata !{i32 786688, metadata !4190, metadata !"ptr", metadata !886, i32 115, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4333 = metadata !{i32 178, i32 4, metadata !4201, null}
!4334 = metadata !{i32 123, i32 26, metadata !4202, null}
!4335 = metadata !{i32 786688, metadata !4202, metadata !"j", metadata !886, i32 123, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4336 = metadata !{i32 179, i32 3, metadata !4203, null}
!4337 = metadata !{i32 786688, metadata !4204, metadata !"i", metadata !886, i32 120, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4338 = metadata !{i32 120, i32 26, metadata !4204, null}
!4339 = metadata !{i32 180, i32 2, metadata !4205, null}
!4340 = metadata !{i32 117, i32 25, metadata !4206, null}
!4341 = metadata !{i32 786688, metadata !4206, metadata !"c", metadata !886, i32 117, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4342 = metadata !{i32 181, i32 1, metadata !4190, null}
!4343 = metadata !{i32 790531, metadata !4344, metadata !"in.V.V", null, i32 51, metadata !4168, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4344 = metadata !{i32 786689, metadata !2188, metadata !"in", metadata !886, i32 16777267, metadata !889, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4345 = metadata !{i32 51, i32 38, metadata !2188, null}
!4346 = metadata !{i32 790531, metadata !4347, metadata !"out.V.V", null, i32 51, metadata !4168, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4347 = metadata !{i32 786689, metadata !2188, metadata !"out", metadata !886, i32 33554483, metadata !889, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4348 = metadata !{i32 51, i32 65, metadata !2188, null}
!4349 = metadata !{i32 786689, metadata !2188, metadata !"ch_div_K", metadata !886, i32 50331699, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4350 = metadata !{i32 51, i32 73, metadata !2188, null}
!4351 = metadata !{i32 786689, metadata !2188, metadata !"height_in", metadata !886, i32 67108915, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4352 = metadata !{i32 51, i32 86, metadata !2188, null}
!4353 = metadata !{i32 786689, metadata !2188, metadata !"width_in", metadata !886, i32 83886131, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4354 = metadata !{i32 51, i32 100, metadata !2188, null}
!4355 = metadata !{i32 786689, metadata !2188, metadata !"Kx", metadata !886, i32 100663347, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4356 = metadata !{i32 51, i32 113, metadata !2188, null}
!4357 = metadata !{i32 56, i32 1, metadata !4358, null}
!4358 = metadata !{i32 786443, metadata !2188, i32 52, i32 1, metadata !886, i32 4} ; [ DW_TAG_lexical_block ]
!4359 = metadata !{i32 57, i32 1, metadata !4358, null}
!4360 = metadata !{i32 58, i32 1, metadata !4358, null}
!4361 = metadata !{i32 59, i32 1, metadata !4358, null}
!4362 = metadata !{i32 63, i32 13, metadata !4363, null}
!4363 = metadata !{i32 786443, metadata !4358, i32 63, i32 2, metadata !886, i32 5} ; [ DW_TAG_lexical_block ]
!4364 = metadata !{i32 64, i32 3, metadata !4365, null}
!4365 = metadata !{i32 786443, metadata !4363, i32 64, i32 2, metadata !886, i32 6} ; [ DW_TAG_lexical_block ]
!4366 = metadata !{i32 65, i32 1, metadata !4365, null}
!4367 = metadata !{i32 66, i32 13, metadata !4368, null}
!4368 = metadata !{i32 786443, metadata !4365, i32 66, i32 2, metadata !886, i32 7} ; [ DW_TAG_lexical_block ]
!4369 = metadata !{i32 67, i32 4, metadata !4370, null}
!4370 = metadata !{i32 786443, metadata !4368, i32 67, i32 3, metadata !886, i32 8} ; [ DW_TAG_lexical_block ]
!4371 = metadata !{i32 68, i32 1, metadata !4370, null}
!4372 = metadata !{i32 69, i32 13, metadata !4373, null}
!4373 = metadata !{i32 786443, metadata !4370, i32 69, i32 2, metadata !886, i32 9} ; [ DW_TAG_lexical_block ]
!4374 = metadata !{i32 70, i32 5, metadata !4375, null}
!4375 = metadata !{i32 786443, metadata !4373, i32 70, i32 4, metadata !886, i32 10} ; [ DW_TAG_lexical_block ]
!4376 = metadata !{i32 71, i32 1, metadata !4375, null}
!4377 = metadata !{i32 72, i32 1, metadata !4375, null}
!4378 = metadata !{i32 790529, metadata !4379, metadata !"in_d3.V", null, i32 61, metadata !4171, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4379 = metadata !{i32 786688, metadata !4358, metadata !"in_d3", metadata !886, i32 61, metadata !2138, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4380 = metadata !{i32 174, i32 5, metadata !4235, metadata !4381}
!4381 = metadata !{i32 74, i32 2, metadata !4375, null}
!4382 = metadata !{i32 790529, metadata !4383, metadata !"in_d2.V", null, i32 61, metadata !4171, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4383 = metadata !{i32 786688, metadata !4358, metadata !"in_d2", metadata !886, i32 61, metadata !2138, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4384 = metadata !{i32 174, i32 5, metadata !4235, metadata !4385}
!4385 = metadata !{i32 74, i32 14, metadata !4375, null}
!4386 = metadata !{i32 790529, metadata !4387, metadata !"in_d1.V", null, i32 61, metadata !4171, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4387 = metadata !{i32 786688, metadata !4358, metadata !"in_d1", metadata !886, i32 61, metadata !2138, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4388 = metadata !{i32 174, i32 5, metadata !4235, metadata !4389}
!4389 = metadata !{i32 74, i32 26, metadata !4375, null}
!4390 = metadata !{i32 129, i32 56, metadata !2305, metadata !4391}
!4391 = metadata !{i32 75, i32 11, metadata !4375, null}
!4392 = metadata !{i32 130, i32 22, metadata !4227, metadata !4391}
!4393 = metadata !{i32 131, i32 9, metadata !4227, metadata !4391}
!4394 = metadata !{i32 173, i32 82, metadata !2304, metadata !4391}
!4395 = metadata !{i32 174, i32 5, metadata !4235, metadata !4391}
!4396 = metadata !{i32 790529, metadata !4397, metadata !"in_d0.V", null, i32 61, metadata !4171, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4397 = metadata !{i32 786688, metadata !4358, metadata !"in_d0", metadata !886, i32 61, metadata !2138, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4398 = metadata !{i32 78, i32 5, metadata !4375, null}
!4399 = metadata !{i32 941, i32 79, metadata !4263, metadata !4400}
!4400 = metadata !{i32 1538, i32 15, metadata !4267, metadata !4401}
!4401 = metadata !{i32 91, i32 99, metadata !2292, metadata !4402}
!4402 = metadata !{i32 91, i32 100, metadata !2200, metadata !4403}
!4403 = metadata !{i32 82, i32 23, metadata !4404, null}
!4404 = metadata !{i32 786443, metadata !4405, i32 81, i32 6, metadata !886, i32 13} ; [ DW_TAG_lexical_block ]
!4405 = metadata !{i32 786443, metadata !4406, i32 80, i32 6, metadata !886, i32 12} ; [ DW_TAG_lexical_block ]
!4406 = metadata !{i32 786443, metadata !4375, i32 79, i32 5, metadata !886, i32 11} ; [ DW_TAG_lexical_block ]
!4407 = metadata !{i32 941, i32 81, metadata !4263, metadata !4400}
!4408 = metadata !{i32 941, i32 79, metadata !4263, metadata !4409}
!4409 = metadata !{i32 1538, i32 15, metadata !4267, metadata !4410}
!4410 = metadata !{i32 91, i32 99, metadata !2292, metadata !4411}
!4411 = metadata !{i32 91, i32 100, metadata !2200, metadata !4412}
!4412 = metadata !{i32 83, i32 23, metadata !4404, null}
!4413 = metadata !{i32 941, i32 81, metadata !4263, metadata !4409}
!4414 = metadata !{i32 941, i32 79, metadata !4263, metadata !4415}
!4415 = metadata !{i32 1538, i32 15, metadata !4267, metadata !4416}
!4416 = metadata !{i32 91, i32 99, metadata !2292, metadata !4417}
!4417 = metadata !{i32 91, i32 100, metadata !2200, metadata !4418}
!4418 = metadata !{i32 84, i32 23, metadata !4404, null}
!4419 = metadata !{i32 941, i32 81, metadata !4263, metadata !4415}
!4420 = metadata !{i32 941, i32 79, metadata !4263, metadata !4421}
!4421 = metadata !{i32 1538, i32 15, metadata !4267, metadata !4422}
!4422 = metadata !{i32 91, i32 99, metadata !2292, metadata !4423}
!4423 = metadata !{i32 91, i32 100, metadata !2200, metadata !4424}
!4424 = metadata !{i32 85, i32 23, metadata !4404, null}
!4425 = metadata !{i32 941, i32 81, metadata !4263, metadata !4421}
!4426 = metadata !{i32 958, i32 115, metadata !4293, metadata !4427}
!4427 = metadata !{i32 89, i32 16, metadata !4428, null}
!4428 = metadata !{i32 786443, metadata !4429, i32 89, i32 15, metadata !886, i32 15} ; [ DW_TAG_lexical_block ]
!4429 = metadata !{i32 786443, metadata !4404, i32 88, i32 7, metadata !886, i32 14} ; [ DW_TAG_lexical_block ]
!4430 = metadata !{i32 2050, i32 5, metadata !4299, metadata !4431}
!4431 = metadata !{i32 90, i32 45, metadata !4432, null}
!4432 = metadata !{i32 786443, metadata !4429, i32 90, i32 15, metadata !886, i32 16} ; [ DW_TAG_lexical_block ]
!4433 = metadata !{i32 2448, i32 93, metadata !4303, metadata !4434}
!4434 = metadata !{i32 2448, i32 109, metadata !2195, metadata !4435}
!4435 = metadata !{i32 957, i32 39, metadata !4294, metadata !4431}
!4436 = metadata !{i32 958, i32 115, metadata !4293, metadata !4431}
!4437 = metadata !{i32 2050, i32 5, metadata !4299, metadata !4438}
!4438 = metadata !{i32 91, i32 53, metadata !4439, null}
!4439 = metadata !{i32 786443, metadata !4429, i32 91, i32 15, metadata !886, i32 17} ; [ DW_TAG_lexical_block ]
!4440 = metadata !{i32 958, i32 115, metadata !4293, metadata !4441}
!4441 = metadata !{i32 91, i32 88, metadata !4439, null}
!4442 = metadata !{i32 2050, i32 5, metadata !4299, metadata !4443}
!4443 = metadata !{i32 92, i32 61, metadata !4444, null}
!4444 = metadata !{i32 786443, metadata !4429, i32 92, i32 15, metadata !886, i32 18} ; [ DW_TAG_lexical_block ]
!4445 = metadata !{i32 2050, i32 5, metadata !4299, metadata !4446}
!4446 = metadata !{i32 92, i32 96, metadata !4444, null}
!4447 = metadata !{i32 958, i32 115, metadata !4293, metadata !4448}
!4448 = metadata !{i32 92, i32 175, metadata !4444, null}
!4449 = metadata !{i32 145, i32 31, metadata !4320, metadata !4450}
!4450 = metadata !{i32 95, i32 6, metadata !4406, null}
!4451 = metadata !{i32 144, i32 48, metadata !2192, metadata !4450}
!4452 = metadata !{i32 145, i32 22, metadata !4320, metadata !4450}
!4453 = metadata !{i32 146, i32 9, metadata !4320, metadata !4450}
!4454 = metadata !{i32 96, i32 5, metadata !4406, null}
!4455 = metadata !{i32 97, i32 4, metadata !4375, null}
!4456 = metadata !{i32 786688, metadata !4373, metadata !"j", metadata !886, i32 69, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4457 = metadata !{i32 69, i32 25, metadata !4373, null}
!4458 = metadata !{i32 98, i32 3, metadata !4370, null}
!4459 = metadata !{i32 66, i32 26, metadata !4368, null}
!4460 = metadata !{i32 786688, metadata !4368, metadata !"i", metadata !886, i32 66, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4461 = metadata !{i32 99, i32 2, metadata !4365, null}
!4462 = metadata !{i32 63, i32 25, metadata !4363, null}
!4463 = metadata !{i32 786688, metadata !4363, metadata !"c", metadata !886, i32 63, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4464 = metadata !{i32 100, i32 1, metadata !4358, null}
!4465 = metadata !{i32 16, i32 1, metadata !4466, null}
!4466 = metadata !{i32 786443, metadata !885, i32 6, i32 1, metadata !886, i32 0} ; [ DW_TAG_lexical_block ]
!4467 = metadata !{metadata !4468}
!4468 = metadata !{i32 0, i32 127, metadata !4469}
!4469 = metadata !{metadata !4470}
!4470 = metadata !{metadata !"in.V.V", metadata !4164, metadata !"int128", i32 0, i32 127}
!4471 = metadata !{metadata !4472}
!4472 = metadata !{i32 0, i32 127, metadata !4473}
!4473 = metadata !{metadata !4474}
!4474 = metadata !{metadata !"out.V.data.V", metadata !4164, metadata !"int128", i32 0, i32 127}
!4475 = metadata !{metadata !4476}
!4476 = metadata !{i32 0, i32 0, metadata !4477}
!4477 = metadata !{metadata !4478}
!4478 = metadata !{metadata !"out.V.last", metadata !4164, metadata !"bool", i32 0, i32 0}
!4479 = metadata !{metadata !4480}
!4480 = metadata !{i32 0, i32 31, metadata !4481}
!4481 = metadata !{metadata !4482}
!4482 = metadata !{metadata !"ch_div_K", metadata !4483, metadata !"int", i32 0, i32 31}
!4483 = metadata !{metadata !4484}
!4484 = metadata !{i32 0, i32 0, i32 0}
!4485 = metadata !{metadata !4486}
!4486 = metadata !{i32 0, i32 31, metadata !4487}
!4487 = metadata !{metadata !4488}
!4488 = metadata !{metadata !"height_in", metadata !4483, metadata !"int", i32 0, i32 31}
!4489 = metadata !{metadata !4490}
!4490 = metadata !{i32 0, i32 31, metadata !4491}
!4491 = metadata !{metadata !4492}
!4492 = metadata !{metadata !"width_in", metadata !4483, metadata !"int", i32 0, i32 31}
!4493 = metadata !{metadata !4494}
!4494 = metadata !{i32 0, i32 31, metadata !4495}
!4495 = metadata !{metadata !4496}
!4496 = metadata !{metadata !"height_out", metadata !4483, metadata !"int", i32 0, i32 31}
!4497 = metadata !{metadata !4498}
!4498 = metadata !{i32 0, i32 31, metadata !4499}
!4499 = metadata !{metadata !4500}
!4500 = metadata !{metadata !"width_out", metadata !4483, metadata !"int", i32 0, i32 31}
!4501 = metadata !{metadata !4502}
!4502 = metadata !{i32 0, i32 31, metadata !4503}
!4503 = metadata !{metadata !4504}
!4504 = metadata !{metadata !"Kx", metadata !4483, metadata !"int", i32 0, i32 31}
!4505 = metadata !{metadata !4506}
!4506 = metadata !{i32 0, i32 31, metadata !4507}
!4507 = metadata !{metadata !4508}
!4508 = metadata !{metadata !"Ky", metadata !4483, metadata !"int", i32 0, i32 31}
!4509 = metadata !{i32 7, i32 1, metadata !4466, null}
!4510 = metadata !{i32 8, i32 1, metadata !4466, null}
!4511 = metadata !{i32 9, i32 1, metadata !4466, null}
!4512 = metadata !{i32 10, i32 1, metadata !4466, null}
!4513 = metadata !{i32 11, i32 1, metadata !4466, null}
!4514 = metadata !{i32 12, i32 1, metadata !4466, null}
!4515 = metadata !{i32 13, i32 1, metadata !4466, null}
!4516 = metadata !{i32 14, i32 1, metadata !4466, null}
!4517 = metadata !{i32 17, i32 1, metadata !4466, null}
!4518 = metadata !{i32 18, i32 1, metadata !4466, null}
!4519 = metadata !{i32 790531, metadata !4520, metadata !"in.V.V", null, i32 3, metadata !4168, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4520 = metadata !{i32 786689, metadata !885, metadata !"in", metadata !886, i32 16777219, metadata !889, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4521 = metadata !{i32 3, i32 35, metadata !885, null}
!4522 = metadata !{i32 790531, metadata !4523, metadata !"out.V.data.V", null, i32 3, metadata !4524, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4523 = metadata !{i32 786689, metadata !885, metadata !"out", metadata !886, i32 33554435, metadata !2130, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4524 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !4525} ; [ DW_TAG_pointer_type ]
!4525 = metadata !{i32 786438, metadata !891, metadata !"stream<dtype_stream>", metadata !892, i32 79, i64 128, i64 128, i32 0, i32 0, null, metadata !4526, i32 0, null, metadata !2183} ; [ DW_TAG_class_field_type ]
!4526 = metadata !{metadata !4527}
!4527 = metadata !{i32 786438, null, metadata !"", metadata !2135, i32 16, i64 128, i64 128, i32 0, i32 0, null, metadata !4170, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!4528 = metadata !{i32 3, i32 65, metadata !885, null}
!4529 = metadata !{i32 790531, metadata !4523, metadata !"out.V.last", null, i32 3, metadata !4530, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4530 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !4531} ; [ DW_TAG_pointer_type ]
!4531 = metadata !{i32 786438, metadata !891, metadata !"stream<dtype_stream>", metadata !892, i32 79, i64 8, i64 128, i32 0, i32 0, null, metadata !4532, i32 0, null, metadata !2183} ; [ DW_TAG_class_field_type ]
!4532 = metadata !{metadata !4533}
!4533 = metadata !{i32 786438, null, metadata !"", metadata !2135, i32 16, i64 8, i64 128, i32 0, i32 0, null, metadata !4534, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!4534 = metadata !{metadata !2139}
!4535 = metadata !{i32 786689, metadata !885, metadata !"ch_div_K", metadata !886, i32 50331652, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4536 = metadata !{i32 4, i32 7, metadata !885, null}
!4537 = metadata !{i32 786689, metadata !885, metadata !"height_in", metadata !886, i32 67108868, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4538 = metadata !{i32 4, i32 20, metadata !885, null}
!4539 = metadata !{i32 786689, metadata !885, metadata !"width_in", metadata !886, i32 83886084, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4540 = metadata !{i32 4, i32 34, metadata !885, null}
!4541 = metadata !{i32 786689, metadata !885, metadata !"height_out", metadata !886, i32 100663301, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4542 = metadata !{i32 5, i32 7, metadata !885, null}
!4543 = metadata !{i32 786689, metadata !885, metadata !"width_out", metadata !886, i32 117440517, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4544 = metadata !{i32 5, i32 22, metadata !885, null}
!4545 = metadata !{i32 786689, metadata !885, metadata !"Kx", metadata !886, i32 134217733, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4546 = metadata !{i32 5, i32 36, metadata !885, null}
!4547 = metadata !{i32 786689, metadata !885, metadata !"Ky", metadata !886, i32 150994949, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4548 = metadata !{i32 5, i32 43, metadata !885, null}
!4549 = metadata !{i32 790529, metadata !4550, metadata !"stream_tp.V.V", null, i32 20, metadata !4169, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4550 = metadata !{i32 786688, metadata !4466, metadata !"stream_tp", metadata !886, i32 20, metadata !890, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4551 = metadata !{i32 20, i32 25, metadata !4466, null}
!4552 = metadata !{i32 790529, metadata !4553, metadata !"stream_tp2.V.V", null, i32 23, metadata !4169, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4553 = metadata !{i32 786688, metadata !4466, metadata !"stream_tp2", metadata !886, i32 23, metadata !890, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4554 = metadata !{i32 23, i32 25, metadata !4466, null}
!4555 = metadata !{i32 25, i32 2, metadata !4466, null}
!4556 = metadata !{i32 26, i32 2, metadata !4466, null}
!4557 = metadata !{i32 27, i32 2, metadata !4466, null}
!4558 = metadata !{i32 28, i32 1, metadata !4466, null}
!4559 = metadata !{i32 790531, metadata !4560, metadata !"in.V.V", null, i32 30, metadata !4168, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4560 = metadata !{i32 786689, metadata !2185, metadata !"in", metadata !886, i32 16777246, metadata !889, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4561 = metadata !{i32 30, i32 38, metadata !2185, null}
!4562 = metadata !{i32 790531, metadata !4563, metadata !"out.V.data.V", null, i32 30, metadata !4524, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4563 = metadata !{i32 786689, metadata !2185, metadata !"out", metadata !886, i32 33554462, metadata !2130, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4564 = metadata !{i32 30, i32 68, metadata !2185, null}
!4565 = metadata !{i32 790531, metadata !4563, metadata !"out.V.last", null, i32 30, metadata !4530, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4566 = metadata !{i32 786689, metadata !2185, metadata !"ch_div_K", metadata !886, i32 50331678, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4567 = metadata !{i32 30, i32 76, metadata !2185, null}
!4568 = metadata !{i32 786689, metadata !2185, metadata !"height_out", metadata !886, i32 67108894, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4569 = metadata !{i32 30, i32 89, metadata !2185, null}
!4570 = metadata !{i32 786689, metadata !2185, metadata !"width_out", metadata !886, i32 83886110, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4571 = metadata !{i32 30, i32 104, metadata !2185, null}
!4572 = metadata !{i32 32, i32 1, metadata !4573, null}
!4573 = metadata !{i32 786443, metadata !2185, i32 31, i32 1, metadata !886, i32 1} ; [ DW_TAG_lexical_block ]
!4574 = metadata !{i32 33, i32 1, metadata !4573, null}
!4575 = metadata !{i32 34, i32 1, metadata !4573, null}
!4576 = metadata !{i32 36, i32 13, metadata !4577, null}
!4577 = metadata !{i32 786443, metadata !4573, i32 36, i32 2, metadata !886, i32 2} ; [ DW_TAG_lexical_block ]
!4578 = metadata !{i32 43, i32 3, metadata !4579, null}
!4579 = metadata !{i32 786443, metadata !4577, i32 37, i32 2, metadata !886, i32 3} ; [ DW_TAG_lexical_block ]
!4580 = metadata !{i32 37, i32 3, metadata !4579, null}
!4581 = metadata !{i32 38, i32 1, metadata !4579, null}
!4582 = metadata !{i32 39, i32 1, metadata !4579, null}
!4583 = metadata !{i32 129, i32 56, metadata !2305, metadata !4584}
!4584 = metadata !{i32 42, i32 11, metadata !4579, null}
!4585 = metadata !{i32 130, i32 22, metadata !4227, metadata !4584}
!4586 = metadata !{i32 131, i32 9, metadata !4227, metadata !4584}
!4587 = metadata !{i32 173, i32 82, metadata !2304, metadata !4584}
!4588 = metadata !{i32 174, i32 5, metadata !4235, metadata !4584}
!4589 = metadata !{i32 790529, metadata !4590, metadata !"tp.data.V", null, i32 41, metadata !4527, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4590 = metadata !{i32 786688, metadata !4579, metadata !"tp", metadata !886, i32 41, metadata !4591, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4591 = metadata !{i32 786454, null, metadata !"dtype_stream", metadata !886, i32 20, i64 0, i64 0, i64 0, i32 0, metadata !2134} ; [ DW_TAG_typedef ]
!4592 = metadata !{i32 790531, metadata !4593, metadata !"stream<dtype_stream>.V.data.V", null, i32 144, metadata !4595, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4593 = metadata !{i32 786689, metadata !2303, metadata !"this", metadata !892, i32 16777360, metadata !4594, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4594 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !2131} ; [ DW_TAG_pointer_type ]
!4595 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !4525} ; [ DW_TAG_pointer_type ]
!4596 = metadata !{i32 144, i32 48, metadata !2303, metadata !4597}
!4597 = metadata !{i32 47, i32 3, metadata !4579, null}
!4598 = metadata !{i32 790531, metadata !4593, metadata !"stream<dtype_stream>.V.last", null, i32 144, metadata !4599, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4599 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !4531} ; [ DW_TAG_pointer_type ]
!4600 = metadata !{i32 790529, metadata !4601, metadata !"tmp.data.V", null, i32 145, metadata !4527, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4601 = metadata !{i32 786688, metadata !4602, metadata !"tmp", metadata !892, i32 145, metadata !2134, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4602 = metadata !{i32 786443, metadata !2303, i32 144, i32 79, metadata !892, i32 48} ; [ DW_TAG_lexical_block ]
!4603 = metadata !{i32 145, i32 22, metadata !4602, metadata !4597}
!4604 = metadata !{i32 790529, metadata !4601, metadata !"tmp.last", null, i32 145, metadata !4533, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4605 = metadata !{i32 145, i32 31, metadata !4602, metadata !4597}
!4606 = metadata !{i32 146, i32 9, metadata !4602, metadata !4597}
!4607 = metadata !{i32 48, i32 2, metadata !4579, null}
!4608 = metadata !{i32 36, i32 46, metadata !4577, null}
!4609 = metadata !{i32 786688, metadata !4577, metadata !"i", metadata !886, i32 36, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4610 = metadata !{i32 49, i32 1, metadata !4573, null}
