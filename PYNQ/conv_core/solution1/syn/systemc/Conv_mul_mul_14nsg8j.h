...
#ifndef __Conv_mul_mul_14nsg8j__HH__
#define __Conv_mul_mul_14nsg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mul_mul_14nsg8j) {
    ...
    SC_CTOR(Conv_mul_mul_14nsg8j):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
