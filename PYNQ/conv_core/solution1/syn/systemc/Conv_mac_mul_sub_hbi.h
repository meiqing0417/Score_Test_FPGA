...
#ifndef __Conv_mac_mul_sub_hbi__HH__
#define __Conv_mac_mul_sub_hbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mac_mul_sub_hbi) {
    ...
    SC_CTOR(Conv_mac_mul_sub_hbi):  simcore_mac_0_U ("simcore_mac_0_U") {
