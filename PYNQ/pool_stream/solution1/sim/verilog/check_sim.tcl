...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.pool.autotvin_in_V_V.dat"
         "c.pool.autotvin_out_V_data_V.dat"
         "c.pool.autotvin_out_V_last.dat"
         "c.pool.autotvin_ch_div_K.dat"
         "c.pool.autotvin_height_in.dat"
         "c.pool.autotvin_width_in.dat"
         "c.pool.autotvin_height_out.dat"
         "c.pool.autotvin_width_out.dat"
         "c.pool.autotvin_Kx.dat"
         "c.pool.autotvin_Ky.dat"
         "c.pool.autotvout_out_V_data_V.dat"
         "c.pool.autotvout_out_V_last.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.pool.autotvout_out_V_data_V.dat"
         "rtl.pool.autotvout_out_V_last.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
