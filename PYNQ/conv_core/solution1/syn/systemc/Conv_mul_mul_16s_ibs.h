...
#ifndef __Conv_mul_mul_16s_ibs__HH__
#define __Conv_mul_mul_16s_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mul_mul_16s_ibs) {
    ...
    SC_CTOR(Conv_mul_mul_16s_ibs):  ACMP_smul_su_U ("ACMP_smul_su_U") {
