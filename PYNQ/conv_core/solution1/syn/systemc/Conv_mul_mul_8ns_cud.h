...
#ifndef __Conv_mul_mul_8ns_cud__HH__
#define __Conv_mul_mul_8ns_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mul_mul_8ns_cud) {
    ...
    SC_CTOR(Conv_mul_mul_8ns_cud):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
