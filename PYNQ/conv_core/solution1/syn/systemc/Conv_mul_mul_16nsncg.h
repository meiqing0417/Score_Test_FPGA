...
#ifndef __Conv_mul_mul_16nsncg__HH__
#define __Conv_mul_mul_16nsncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mul_mul_16nsncg) {
    ...
    SC_CTOR(Conv_mul_mul_16nsncg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
