...
#ifndef __Conv_mul_mul_8ns_jbC__HH__
#define __Conv_mul_mul_8ns_jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mul_mul_8ns_jbC) {
    ...
    SC_CTOR(Conv_mul_mul_8ns_jbC):  ACMP_smul_us_U ("ACMP_smul_us_U") {
